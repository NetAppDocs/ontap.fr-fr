...
summary: 'ONTAP propose différentes approches permettant aux clients d"exploiter un ABAC de niveau fichier, notamment des étiquettes de sécurité NFS v4.2 et des xattrs avec NFS.' 
---
...
[role="lead"]
ONTAP propose plusieurs approches permettant aux clients d'exploiter le contrôle d'accès basé sur des attributs (ABAC) au niveau des fichiers, notamment les étiquettes de sécurité NFS v4.2 et les attributs étendus (xattrs) à l'aide de NFS.
