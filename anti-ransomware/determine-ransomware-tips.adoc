...
summary: Découvrez comment déterminer si un événement ONTAP ARP ou ARP/AI signalé correspond à une véritable attaque de ransomware ou à un faux positif, et comment y répondre. 
---
...
Si l'alerte survient quelques heures ou quelques jours après l'activation de la protection autonome contre les ransomwares, il s'agit probablement d'un faux positif. Si aucune alerte ne survient pendant plusieurs jours après l'activation de la protection autonome contre les ransomwares, puis qu'une alerte apparaît, la probabilité d'une véritable attaque est plus élevée.
...
* link:respond-arpai.html["Réagir à une activité anormale : ARP/AI (ONTAP 9.16.1 et versions ultérieures)"]
* link:respond-arp.html["Réagir à une activité anormale : ARP (ONTAP 9.15.1 et versions antérieures)"]
