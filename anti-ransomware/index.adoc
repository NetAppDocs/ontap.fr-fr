...
Avec ONTAP 9.15.1 à 9.10.1, ARP passe en mode actif une fois la période d'apprentissage optimale terminée. Une fois ARP activé, ONTAP crée des snapshots ARP pour protéger les données en cas de détection d'une menace.
