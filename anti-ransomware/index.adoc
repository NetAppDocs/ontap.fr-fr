...
* *SnapMirror synchronisation synchrone et active* : À partir de ONTAP 9.19.1 RC, les instantanés ARP créés pour les volumes participant à des relations de SnapMirror synchrones ou de synchronisation active SnapMirror suivent les règles supplémentaires suivantes :
+
