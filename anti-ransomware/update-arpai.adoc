...
summary: 'Maintenez la protection ARP/AI à jour contre les dernières menaces de ransomware en mettant à jour automatiquement ou manuellement les modules de sécurité ARP/AI indépendamment du rythme de publication d"ONTAP.' 
---
...
NOTE: ARP (ONTAP 9.10.1 à 9.15.1) ne prend pas en charge les mises à jour automatiques du modèle de sécurité. Les capacités de détection de sécurité sont mises à jour uniquement lors des mises à niveau du logiciel ONTAP. Si vous utilisez ONTAP 9.15.1 ou une version antérieure, consultez link:index.html["Découvrez la protection autonome contre les ransomwares"].
...
NOTE: Veillez à installer uniquement une mise à jour ARP/AI plus récente que votre version actuelle afin d'éviter toute rétrogradation involontaire d'ARP/AI.
...
* link:learn-about-arpai.html["Découvrez ARP/IA"]
