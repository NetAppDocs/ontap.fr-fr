...
* Après la mise à niveau vers ONTAP 9.19.1 RC et l'activation d'ARP, la relation peut brièvement se désynchroniser. Cet état est temporaire et la relation devrait se resynchroniser automatiquement sans intervention.
