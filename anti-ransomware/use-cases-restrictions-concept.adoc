...
* Après la mise à niveau vers ONTAP 9.19.1 RC et l'activation d'ARP sur les volumes faisant partie de relations SnapMirror synchrones ou de synchronisation active SnapMirror, la relation peut brièvement se désynchroniser. Cet état est temporaire et la relation devrait se resynchroniser automatiquement sans intervention.
