...
* À partir de ONTAP 9.14.1, vous pouvez utiliser des caractères génériques pour spécifier à la demande les chemins et les extensions de fichiers à exclure.
