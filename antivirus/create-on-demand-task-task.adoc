...
+
Pour obtenir la liste complète des options, reportez-vous au link:https://docs.netapp.com/us-en/ontap-cli/vserver-vscan-on-demand-task-create.html["référence de commande"^].
