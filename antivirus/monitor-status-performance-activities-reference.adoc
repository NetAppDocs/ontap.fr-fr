...
Vous pouvez afficher les statistiques spécifiques au serveur Vscan pour surveiller les performances et diagnostiquer les problèmes liés à l'analyse antivirus. Vous devez collecter un échantillon de données avant de pouvoir utiliser `statistics show` la commande pour afficher les statistiques du serveur Vscan. Pour en savoir plus, `statistics show` consultez le link:https://docs.netapp.com/us-en/ontap-cli/statistics-show.html["Référence de commande ONTAP"^].
...
+
Pour en savoir plus, `statistics` consultez le link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=statistics["Référence de commande ONTAP"^].
...
Pour en savoir plus, `statistics show` consultez le link:https://docs.netapp.com/us-en/ontap-cli/statistics-show.html#description["Référence de commande ONTAP"^].
...
Pour en savoir plus, `statistics show` consultez le link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=statistics+show["Référence de commande ONTAP"^].
