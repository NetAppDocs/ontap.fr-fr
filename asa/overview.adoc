...
System Manager vous guide tout au long des procédures nécessaires pour initialiser votre cluster, créer un niveau local, configurer les protocoles et provisionner le stockage de votre ASA. Reportez-vous aux étapes à xref:../software_setup/concept_decide_whether_to_use_ontap_cli.html[Configurez ONTAP].
