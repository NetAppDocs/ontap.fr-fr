...
À partir de ONTAP 9.15.1, vous fournissez ces valeurs avec `security dynamic-authorization modify` commande. Pour plus d'informations sur la configuration d'autorisation dynamique, reportez-vous à la section link:dynamic-authorization-overview.html["présentation de l'autorisation dynamique"].
