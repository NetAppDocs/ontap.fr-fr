...
[NOTE]
====
À partir de ONTAP 9.2, le `-ldap-servers` remplace le `-servers` légale. Ce nouveau champ peut prendre un nom d'hôte ou une adresse IP comme valeur pour le serveur LDAP.
...
[NOTE]
====
À partir de ONTAP 9.2, le `-nis-servers` remplace le `-servers` légale. Ce nouveau champ peut prendre un nom d'hôte ou une adresse IP comme valeur pour le serveur NIS.
