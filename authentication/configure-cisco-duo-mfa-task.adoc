...
Vous pouvez afficher les entrées de groupe Cisco Duo existantes à l'aide de la[`security login duo group show` commande. Pour en savoir plus sur la commande link:https://docs.NetApp.com/US-en/ONTAP-cli//security-login-duo-group-show.html[`security login duo group show`^], consultez la référence de commande ONTAP.
