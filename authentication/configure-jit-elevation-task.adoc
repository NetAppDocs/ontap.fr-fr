...
* L'élévation de privilèges JIT est uniquement prise en charge pour les utilisateurs qui se connectent par mot de passe, nsswitch ou authentification de domaine. L'authentification multifacteur (MFA) n'est pas prise en charge pour l'élévation de privilèges JIT.
