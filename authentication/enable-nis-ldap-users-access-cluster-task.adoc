...
====
+
La commande suivante crée une configuration de domaine NIS sur SVM « engData ». Le domaine NIS « nisdomain » est actif lors de la création et communique avec un serveur NIS avec l'adresse IP 192.0.2.180.
