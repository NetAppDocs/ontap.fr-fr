...
summary: 'À partir d"ONTAP 9.14, vous avez la possibilité de contrôler l"accès à vos clusters ONTAP en utilisant le cadre Open Authorization (OAuth 2.0). Vous pouvez configurer cette fonctionnalité à l"aide de n"importe quelle interface d"administration ONTAP, y compris l"interface de ligne de commande ONTAP (CLI), System Manager et l"API REST ONTAP. Cependant, les décisions d"autorisation OAuth 2.0 et de contrôle d"accès ne peuvent être appliquées que lorsqu"un client accède à ONTAP via l"API REST ONTAP.' 
---
...
[role="lead"]
À partir d'ONTAP 9.14, vous avez la possibilité de contrôler l'accès à vos clusters ONTAP en utilisant le cadre Open Authorization (OAuth 2.0). Vous pouvez configurer cette fonctionnalité à l'aide de n'importe quelle interface d'administration ONTAP, y compris l'interface de ligne de commande ONTAP (CLI), System Manager et l'API REST ONTAP. Cependant, les décisions d'autorisation OAuth 2.0 et de contrôle d'accès ne peuvent être appliquées que lorsqu'un client accède à ONTAP via l'API REST ONTAP.
