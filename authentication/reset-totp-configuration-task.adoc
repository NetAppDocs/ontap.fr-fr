...
NOTE: À partir d'ONTAP 9.19.1, vous devez saisir un code TOTP valide ou un code de secours pour supprimer votre clé secrète TOTP à l'aide de la CLI. Vous ne pouvez pas supprimer votre clé secrète TOTP à l'aide de l'API REST.
