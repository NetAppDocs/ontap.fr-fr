...
summary: La licence FabricPool que vous avez utilisée auparavant est en train de changer et ne sera conservée que pour les configurations qui ne sont pas prises en charge dans BlueXP. 
---
...
+
.. Dans le volet *Paramètres du cluster*, sur la carte *licences*, cliquez sur image:icon_arrow.gif["icône de flèche"].
