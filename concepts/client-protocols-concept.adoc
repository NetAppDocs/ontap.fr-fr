...
summary: 'ONTAP prend en charge tous les principaux protocoles clients standard de l"industrie, notamment NFS, SMB, FC, FCoE, iSCSI, NVMe et S3.' 
---
= Découvrez les protocoles clients ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
