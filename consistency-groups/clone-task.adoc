...
* Si vous tentez de cloner un groupe de cohérence à partir d'une copie Snapshot qui ne reflète pas la configuration actuelle du groupe de cohérence, l'opération échoue.
