...
[role="lead"]
Les groupes de cohérence peuvent être créés avec des volumes existants ou avec de nouveaux volumes. Une fois qu'un volume est ajouté à un groupe de cohérence, ce dernier ne peut pas être ajouté à un autre groupe de cohérence.
