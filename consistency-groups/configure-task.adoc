...
[role="lead"]
Les groupes de cohérence peuvent être créés avec des volumes existants ou avec de nouvelles LUN. Une fois qu'un volume est associé à un groupe de cohérence, il ne peut pas être ajouté à un autre groupe de cohérence.
