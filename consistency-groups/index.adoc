...
Depuis la ONTAP 9.11.1, les groupes de cohérence prennent également en charge link:protect-task.html#two-phase["création de copies snapshot de groupe de cohérence en deux phases"].
