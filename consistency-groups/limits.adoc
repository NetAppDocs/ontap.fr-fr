...
NOTE: Si vous utilisez la continuité de l'activité SnapMirror, reportez-vous à link:../smbc/considerations-limits.html["Restrictions et limitations de SM-BC pour les limites"].
