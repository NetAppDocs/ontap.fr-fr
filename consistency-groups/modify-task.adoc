...
* Dans ONTAP 9.12.1 et les versions antérieures, vous _ne pouvez pas_ ajouter de volumes à un groupe de cohérence dans une relation SM-BC. Vous devez d'abord interrompre la relation SM-BC, modifier le groupe de cohérence, puis restaurer la protection avec SM-BC.
