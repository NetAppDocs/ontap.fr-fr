...
. link:https://docs.netapp.com/us-en/bluexp-setup-admin/task-managing-netapp-accounts.html["Générez une clé d'accès et une clé secrète à l'aide de BlueXP"^].
