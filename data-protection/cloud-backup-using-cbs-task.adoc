...
.Étapes
. Dans le Gestionnaire système, cliquez sur *protection > vue d'ensemble*, puis faites défiler jusqu'à la section *sauvegarde et récupération BlueXP *.
...
. Cliquez sur *connecter et activer la sauvegarde et la récupération BlueXP *.
