...
[role="lead"]
À partir d'ONTAP 9.9.1, vous pouvez utiliser  lorsque vous souhaitez migrer vos workflows de protection des données vers le cloud. Au lieu des architectures de sauvegarde sur bande traditionnelles, vous pouvez utiliser le stockage objet comme référentiel alternatif pour la conservation des données et l'archivage à long terme. Vous pouvez utiliser des fournisseurs comme Amazon S3, Alibaba Cloud, Azure Blob, Google Cloud Storage, IBM Cloud Object Storage, StorageGRID ou ONTAP S3 comme stockage objet cloud.

À partir d'ONTAP 9.9.1, vous pouvez utiliser System Manager pour sauvegarder et restaurer vos données.
