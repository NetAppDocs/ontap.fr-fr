...
À partir de ONTAP 9.16.1, la sauvegarde cloud SnapMirror prend en charge les relations de ventilateur. Des sauvegardes SnapMirror peuvent ainsi être créées simultanément sur deux magasins d'objets différents.
