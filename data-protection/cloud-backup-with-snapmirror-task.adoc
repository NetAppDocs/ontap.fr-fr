...
* La sauvegarde cloud SnapMirror prend en charge les relations en éventail. Des sauvegardes SnapMirror peuvent ainsi être créées simultanément sur deux magasins d'objets différents.
