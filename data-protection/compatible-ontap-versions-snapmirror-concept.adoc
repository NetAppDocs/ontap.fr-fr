...
[NOTE]
====
L'astérisque (*) après la version de version indique une version Cloud volumes ONTAP uniquement.
...
[NOTE]
====
Les miroirs DP-type ne peuvent pas être initialisés depuis ONTAP 9.11.1 et seront complètement obsolètes dans une prochaine version. Pour plus d'informations, voir link:https://mysupport.netapp.com/info/communications/ECMLP2880221.html["Dérecation des relations SnapMirror de protection des données"^].
