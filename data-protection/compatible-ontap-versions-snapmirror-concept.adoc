...
* Vous pouvez utiliser SVM DR pour migrer une SVM qui ne répond pas aux restrictions indiquées pour link:../svm-migrate/index.html["Migration SVM (mobilité des données SVM)"].
