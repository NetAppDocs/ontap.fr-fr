...
summary: 'Une politique de création d"instantanés définit la manière dont le système crée des instantanés. Cette politique spécifie quand créer des instantanés, combien de copies conserver et comment les nommer.' 
---
