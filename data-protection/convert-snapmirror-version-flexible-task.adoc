...
----
+
Pour connaître la syntaxe complète de la commande, reportez-vous au link:https://docs.netapp.com/us-en/ontap-cli-9141//snapmirror-quiesce.html["page de manuel"^].
...
----
+
Pour connaître la syntaxe complète de la commande, reportez-vous au link:https://docs.netapp.com/us-en/ontap-cli-9141//snapmirror-break.html["page de manuel"^].
...
----
+
Pour connaître la syntaxe complète de la commande, reportez-vous au link:https://docs.netapp.com/us-en/ontap-cli-9141//snapmirror-delete.html["page de manuel"^].
