...
----
+
Pour connaître la syntaxe complète de la commande, reportez-vous au link:https://docs.netapp.com/us-en/ontap-cli-9131//snapmirror-quiesce.html["page de manuel"^].
...
----
+
Pour connaître la syntaxe complète de la commande, reportez-vous au link:https://docs.netapp.com/us-en/ontap-cli-9131//snapmirror-break.html["page de manuel"^].
...
----
+
Pour connaître la syntaxe complète de la commande, reportez-vous au link:https://docs.netapp.com/us-en/ontap-cli-9131//snapmirror-delete.html["page de manuel"^].
