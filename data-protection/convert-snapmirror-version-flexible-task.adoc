...
---
= Convertir une relation de type DP existante en XDP dans ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
----
+
Pour en savoir plus sur la commande link:https://docs.NetApp.com/US-en/ONTAP-cli/SnapMirror-quiesce.html[`snapmirror quiesce`], consultez le document de référence de la commande ONTAP.
