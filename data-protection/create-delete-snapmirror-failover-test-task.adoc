...
. Sélectionnez image:icon_kabob.gif["Options de menu"] En regard de la source de la relation et choisissez *Test Failover*.
...
. Cliquez sur image:icon_add_blue_bg.gif["Menu Ajouter un partage"] Et choisissez *partager*.
...
.Étapes
. Sur le cluster de destination, sélectionnez *protection > relations*.
. Sélectionnez image:icon_kabob.gif["Options de menu"] En regard de la source de la relation et choisissez *nettoyer le basculement de test*.
