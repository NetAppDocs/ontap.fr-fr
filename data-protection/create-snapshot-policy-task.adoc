...
summary: 'Une stratégie de création d"instantanés spécifie quand créer des instantanés, combien de copies conserver et comment les nommer. Une stratégie de création d"instantanés peut contenir jusqu"à cinq planifications de tâches.' 
---
