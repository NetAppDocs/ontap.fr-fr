...
Les instantanés de conservation à long terme sont disponibles uniquement pour les configurations FlexVol SnapMirror . Vous ne pouvez pas créer d'instantanés de conservation à long terme pour les configurations FlexGroup SnapMirror .
