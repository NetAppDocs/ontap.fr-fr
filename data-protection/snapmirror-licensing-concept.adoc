...
+
Si votre système a été acheté avant juin 2019 avec un pack Premium ou Flash, vous pouvez télécharger une clé de licence NetApp pour obtenir la licence synchrone SnapMirror requise à partir du site d’assistance NetApp https://mysupport.netapp.com/NOW/knowledge/docs/olio/guides/master_lickey/["Clés de licence"^].
