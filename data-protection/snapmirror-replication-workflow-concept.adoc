...
summary: Pour chaque type de relation de protection des données SnapMirror, le flux de travail est identique. Vous créez un volume de destination, créez une planification de tâche, spécifiez une stratégie, puis créez et initialisez la relation. 
---
