...
** Les associations de volumes avec les politiques de snapshot définies par l'utilisateur et le système ne sont pas copiées vers la SVM de destination.
...
Activation d'IPsec
 a| 
Non pris en charge à partir de ONTAP 9.19.1.
