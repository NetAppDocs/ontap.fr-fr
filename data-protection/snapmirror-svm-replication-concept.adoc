...
Lorsque vous configurez une relation SVM DR à l'aide de la règle mirror-vault en utilisant ONTAP 9.9.1 et versions ultérieures, la politique se comporte comme suit :
