...
| Relations synchrones intra-cluster | ONTAP 9.13.1P6 | Les volumes source et destination doivent se trouver au sein de différents SVM.
Les volumes source et de destination sont placés sur différentes paires haute disponibilité.
