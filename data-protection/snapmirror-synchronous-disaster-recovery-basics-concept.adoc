...
| Protection anti-ransomware autonome | ONTAP 9.19.1 | Si vous activez ARP sur des volumes faisant partie de relations de synchronisation SnapMirror synchrones ou de synchronisation active SnapMirror après la mise à niveau, la relation passe brièvement à un état désynchronisé. Cet état est temporaire et la relation devrait se resynchroniser automatiquement sans intervention. Pour plus d'informations, consultez link:../anti-ransomware/use-cases-restrictions-concept.html["Cas d'utilisation et considérations relatives à la protection autonome contre les ransomwares"]. 
