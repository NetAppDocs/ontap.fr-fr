...
| Protection anti-ransomware autonome | ONTAP 9.19.1 | Après la mise à niveau vers ONTAP 9.19.1 RC et l'activation d'ARP sur les volumes faisant partie de relations synchrones SnapMirror, il est possible que la relation soit brièvement en état de désynchronisation. Cet état est temporaire et la relation devrait se resynchroniser automatiquement sans intervention. 
