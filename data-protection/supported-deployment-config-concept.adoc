...
[NOTE]
====
Notez que les volumes faisant partie d'une configuration « fan-out » ou en cascade peuvent prendre plus de temps pour resynchroniser. Il n'est pas rare de voir la relation SnapMirror indiquant l'état « préparation » pour une période prolongée.
