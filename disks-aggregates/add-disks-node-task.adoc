...
Le nombre minimum de HDD que vous devez ajouter en une seule procédure est de six. Le nombre minimum de SSD que vous devez ajouter en une seule procédure est de trois. L'ajout d'un seul disque peut réduire les performances.
