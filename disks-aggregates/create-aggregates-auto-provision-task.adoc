...
Acceptez les recommandations de System Manager.
 a| 
Passez à la section ,Étape de configuration du gestionnaire de clés intégré pour le chiffrement.
...
Le `storage aggregate auto-provision` la page man contient plus d'informations sur les recommandations de disposition globale.
