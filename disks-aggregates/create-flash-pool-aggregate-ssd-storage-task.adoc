...
. Localisez à nouveau le niveau de stockage et cliquez sur image:icon_kabob.gif["icône kabob"].
...
--
====
http://www.netapp.com/us/media/tr-4070.pdf["Rapport technique NetApp 4070 : Guide de la conception et de l'implémentation Flash Pool"^]
