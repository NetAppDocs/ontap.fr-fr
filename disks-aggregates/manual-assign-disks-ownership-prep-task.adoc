...
+
image::../media/dwg_trafford_drawer_with_hdds_callouts.gif[Cette illustration montre la numérotation et les emplacements de la baie de lecteur dans un tiroir DS460C]
