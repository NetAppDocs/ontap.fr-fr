...
summary: 'Le package de qualification de disque (DQP) assure la prise en charge complète des disques nouvellement qualifiés. Avant de mettre à jour le firmware ou d"ajouter de nouveaux types ou tailles de disques à un cluster, vous devez mettre à jour le DQP. Une bonne pratique consiste également à mettre à jour régulièrement le DQP.' 
---
