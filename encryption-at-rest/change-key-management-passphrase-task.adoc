...
---
= Modifiez la phrase secrète de gestion des clés intégrée avec ONTAP
:allow-uri-read: 
...
|===
+
Pour en savoir plus, `security key-manager update-passphrase` consultez le link:https://docs.netapp.com/us-en/ontap-cli/security-key-manager-update-passphrase.html["Référence de commande ONTAP"^].
