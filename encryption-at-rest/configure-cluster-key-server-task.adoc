...
* Pour en savoir plus sur les commandes décrites dans cette procédure, consultez le link:https://docs.netapp.com/us-en/ontap-cli/["Référence de commande ONTAP."]
