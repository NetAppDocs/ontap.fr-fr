...
Étendue des SVM
 a| 
MetroCluster est pris en charge à partir d' ONTAP 9.8.

À partir d' ONTAP 9.6, NVE prend en charge la portée SVM pour la gestion des clés externes uniquement, et non pour Onboard Key Manager.
