...
Volumes FlexGroup
 a| 
Depuis ONTAP 9.2, les volumes FlexGroup sont pris en charge. Les agrégats de destination doivent être du même type que les agrégats source, au niveau des volumes ou de l'agrégat. ONTAP 9.5 prend en charge le renouvellement de clés des volumes FlexGroup sur place,
