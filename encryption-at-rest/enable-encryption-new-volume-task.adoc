...
|===
+
Pour en savoir plus sur la commande link:https://docs.NetApp.com/US-en/ONTAP-cli/volume-create.html[`volume create`^], consultez la référence de commande ONTAP.
