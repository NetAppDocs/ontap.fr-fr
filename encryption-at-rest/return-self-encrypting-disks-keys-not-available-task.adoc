...
* link:https://docs.netapp.com/us-en/ontap-cli/storage-encryption-disk-revert-to-original-state.html["disque de cryptage de stockage retour à l'état d'origine"^]
