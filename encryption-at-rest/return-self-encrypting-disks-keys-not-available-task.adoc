...
Pour connaître la syntaxe complète de la commande, reportez-vous au link:https://docs.netapp.com/us-en/ontap-cli/storage-disk-assign.html["référence de commande"^].
