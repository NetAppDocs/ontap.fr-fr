...
---
= StorageGRID en tant que niveau cloud ONTAP FabricPool vidéo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
https://www.youtube.com/embed/0pnStpBCqrw?rel=0["Vidéo NetApp : comment connecter StorageGRID Webscale en tant que niveau de capacité externe FabricPool"^]
