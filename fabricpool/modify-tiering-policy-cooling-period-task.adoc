...
link:tiering-policies-concept.html#what-happens-when-you-modify-a-volume-tiering-policy["Que se passe-t-il lorsque vous modifiez une politique de hiérarchisation des volumes"]
...
** `none`
+
link:tiering-policies-concept.html["FabricPool volume politiques de hiérarchisation"]
