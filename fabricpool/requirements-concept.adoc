...
====
+
https://["Prise en charge de la sauvegarde et de la restauration NDMP pour FabricPool"]
...
*** FAS2620
+
Fait https://["Hardware Universe"^] pour les derniers modèles pris en charge.
...
+
http://["Rapport technique de NetApp 4598 : meilleures pratiques FabricPool dans ONTAP 9"^]
