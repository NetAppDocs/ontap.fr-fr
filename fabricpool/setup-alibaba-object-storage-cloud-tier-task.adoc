...
* A link:https://console.netapp.com/cloud-tiering["Licence NetApp Cloud Tiering"^] est requis lors du tiering vers Alibaba Cloud Object Storage. Pour plus d'informations, voir link:install-license-aws-azure-ibm-task.html["Installez une licence FabricPool sur un cluster ONTAP"].
