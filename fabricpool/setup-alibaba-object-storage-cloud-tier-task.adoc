...
* UNlink:https://console.netapp.com/cloud-tiering["Licence NetApp Cloud Tiering"] est requis lors de la hiérarchisation vers Alibaba Cloud Object Storage. Pour plus d'informations, consultez la section link:install-license-aws-azure-ibm-task.html["Installez une licence FabricPool sur un cluster ONTAP"] .
