...
* A link:install-license-aws-azure-ibm-task.html["Licence FabricPool"] est requis lors du tiering vers Azure Blob Storage à partir de clusters ONTAP locaux.
* Aucune licence n'est requise si vous utilisez Azure Blob Storage depuis Cloud Volumes ONTAP ou Azure NetApp Files.
