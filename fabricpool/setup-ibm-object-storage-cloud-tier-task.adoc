...
* A link:install-license-aws-azure-ibm-task.html["Licence FabricPool"] est requis lors du tiering vers IBM Cloud Object Storage à partir de clusters sur site.
