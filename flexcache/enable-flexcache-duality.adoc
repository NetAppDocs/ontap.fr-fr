...
NOTE: Pour une documentation plus complète sur la dualité FlexCache, voir link:../s3-multiprotocol/index.html#how-s3-multiprotocol-support-works["Prise en charge multiprotocole ONTAP S3"^].
