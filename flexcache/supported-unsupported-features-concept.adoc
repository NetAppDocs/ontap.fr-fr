...
Prise en charge à partir d' ONTAP 9.5.  Le SVM principal d'une relation SVM DR peut avoir le volume d'origine ; cependant, si la relation SVM DR est rompue, la relation FlexCache doit être recréée avec un nouveau volume d'origine.
 a| 
Non
