...
* Désactivez SMB Multichannel avant d'activer l'équilibrage de capacité avancé. L'utilisation de SMB Multichannel avec le rééquilibrage de capacité avancé peut entraîner une latence élevée. Pour plus d'informations, voir link:https://kb.netapp.com/on-prem/ontap/da/NAS/NAS-Issues/CONTAP-400433["CONTAP-400433 : Latence de lecture/écriture élevée lors de l’utilisation du rééquilibrage/GDD FlexGroup sur des clients avec SMB Multichannel activé"].
