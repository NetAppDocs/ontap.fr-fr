...
Depuis ONTAP 9.8, vous pouvez utiliser la fonctionnalité de suppression rapide des répertoires à l'aide de l'interface de ligne de commande ONTAP. Depuis la version ONTAP 9.9.1, vous pouvez utiliser cette fonctionnalité avec System Manager. Pour plus d'informations sur ce processus, voir https://["Prendre les mesures correctives basées sur l'analytique"].

[role="tabbed-block"]
====
.System Manager
--
Pour plus d'informations, voir https://["Prendre les mesures correctives basées sur l'analytique"].
