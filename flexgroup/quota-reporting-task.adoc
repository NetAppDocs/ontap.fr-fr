...
** Espace libre = limite stricte moins l'utilisation de l'espace qtree sans limite matérielle, l'utilisation de l'espace est calculée à partir d'un client NFS comme suit :
