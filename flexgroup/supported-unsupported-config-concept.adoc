...
* Balisage des copies Snapshot : prise en charge de la création, de la modification et de la suppression de balises de copie Snapshot (étiquette et commentaire SnapMirror) pour les copies Snapshot sur des volumes FlexGroup à l'aide du `volume snapshot` commande.
