...
== Fonctionnalités prises en charge à partir d' ONTAP 9.18.1

* xref:../performance-admin/adaptive-qos-policy-groups-task.html[Politiques QoS imbriquées]sont prises en charge pour les paires d'objets suivantes :
+
** SVM et volumes FlexGroup contenus par le SVM
** Volumes FlexGroup et qtrees dans les volumes
...
* xref:../anti-ransomware/index.html[Protection autonome contre les ransomwares] pour les volumes FlexGroup, y compris la fonctionnalité suivante prise en charge :
+
