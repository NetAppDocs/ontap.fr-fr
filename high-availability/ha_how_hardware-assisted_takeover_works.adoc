...
https://kb.netapp.com/on-prem/ontap/Ontap_OS/OS-KBs/Hardware-assisted_(HWassist)_takeover_-_Resolution_guide["Basculement assisté par matériel (HWAssist) - Guide de résolution"^]
