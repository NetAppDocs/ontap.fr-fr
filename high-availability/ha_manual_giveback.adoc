...
Vous pouvez lancer manuellement un retour sur un nœud d'une paire haute disponibilité pour renvoyer le stockage au propriétaire d'origine après la maintenance ou pour résoudre tout problème ayant provoqué le basculement.
