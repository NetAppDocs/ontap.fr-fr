...
.Procédure pour le système d'exploitation Oracle Linux 10.x
[#OL10x%collapsible]
====
Utilisez cette procédure si votre système d'exploitation est *Oracle Linux 10.x* pour activer l'accès aux référentiels :
...
====
.Procédure pour le système d'exploitation Oracle Linux 9.x
[#OL9x%collapsible]
====
Utilisez cette procédure si votre système d'exploitation est *Oracle Linux 9.x* pour activer l'accès aux référentiels :
