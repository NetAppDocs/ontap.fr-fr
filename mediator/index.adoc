...
* À partir d' ONTAP Mediator 1.11, IPv6 pour MCCIP est pris en charge.
...
* Si vous utilisez un pare-feu tiers, consultezlink:https://docs.netapp.com/us-en/ontap-metrocluster/install-ip/concept_mediator_requirements.html#firewall-requirements-for-ontap-mediator["Exigences relatives au pare-feu pour le médiateur ONTAP"^] .
...
* Ne mettez pas à niveau le noyau au-delà de la version du système d'exploitation prise en charge pour votre version ONTAP Mediator, car le module SCST testé ne fonctionnera probablement pas.
