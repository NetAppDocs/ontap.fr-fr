...
NOTE: Pour ignorer la vérification automatique de la signature lors de l'installation, utilisez la commande suivante : `./ontap-mediator-1.9.1/ontap-mediator-1.9.1 -y --skip-code-signature-check`
