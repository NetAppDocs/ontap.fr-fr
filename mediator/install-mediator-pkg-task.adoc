...
NOTE: Pour ignorer la vérification de signature lors de l'installation, utilisez cette commande : `./ontap-mediator-1.11.0/ontap-mediator-1.11.0 -y --skip-code-signature-check`
...
.Exemple d'installation d'ONTAP Mediator (sortie console)
[%collapsible]
====
[listing]
----
