...
+
Vous pouvez également utiliser l’ `--https-only`option dans la `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y`commande pour spécifier uniquement HTTPS.
...
[NOTE]
====
Pour ignorer la vérification de signature lors de l'installation, utilisez cette commande : `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y --skip-code-signature-check`
