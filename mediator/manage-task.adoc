...
NOTE: Si vous effectuez une première installation et souhaitez préinstaller SCST avant d'installer ONTAP Mediator, vous pouvez ignorer cette étape.  Le programme d'installation ONTAP Mediator applique tous les correctifs pertinents aux composants SCST lors de l'installation.
