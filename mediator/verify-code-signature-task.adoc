...
`ontap-mediator-1.6.0`
 a| 
Exécutable d'installation du produit pour la version 1.6.0
...
----
. Vérifiez le `ontap-mediator-1.5.0.sig.tsr` et `ontap-mediator-1.6.0.tsr` fichiers utilisant les certificats associés :
+
`openssl ts -verify`
