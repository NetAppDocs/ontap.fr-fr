...
[NOTE]
====
* À partir du 15 juin 2025, vous ne pourrez plus installer ni mettre à niveau ONTAP Mediator 1.9 et 1.8, car les certificats de vérification de signature de code ont expiré. Installez ou mettez à niveau ONTAP Mediator 1.10.
