...
`ontap-mediator-1.8.0`
 a| 
Exécutable d'installation du produit pour la version 1.8.0
...
----
. Vérifiez le `ontap-mediator-1.8.0.sig.tsr` et `ontap-mediator-1.8.0.tsr` fichiers utilisant les certificats associés :
+
`openssl ts -verify`
