...
`ontap-mediator-1.12.0`
 a| 
Le fichier exécutable d'installation du produit pour la version 1.12
...
----
. Vérifiez les  `ontap-mediator-1.12.0.sig.tsr` et  `ontap-mediator-1.12.0.tsr` fichiers à l'aide des certificats associés :
+
[role="tabbed-block"]
====
.OpenSSL 3.x
