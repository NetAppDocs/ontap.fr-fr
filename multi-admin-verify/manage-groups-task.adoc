...
+
.. Cliquez sur *Cluster > Paramètres.*
.. Cliquez sur image:icon_arrow.gif["icône de flèche bleue"] En regard de *Multi-Admin Approval* dans la section *Security*.
(Vous verrez le image:icon_gear.gif["icône de vitesse"] Si MAV n'est pas encore configuré.)
+
