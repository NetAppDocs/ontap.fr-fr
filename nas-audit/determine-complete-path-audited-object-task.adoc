...
summary: 'Le chemin d"accès à l"objet imprimé dans la balise ObjectName pour un enregistrement d"audit contient le nom du volume entre parenthèses et le chemin relatif à partir de la racine du volume conteneur. Si vous souhaitez déterminer le chemin complet de l"objet audité, y compris le chemin de jonction, certaines étapes doivent être suivies.' 
---
