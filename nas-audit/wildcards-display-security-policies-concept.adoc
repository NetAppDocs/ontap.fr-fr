...
summary: 'Vous pouvez utiliser le caractère générique pour afficher des informations sur la sécurité des fichiers et les politiques d"audit de tous les fichiers et répertoires situés sous un chemin donné ou un volume racine.' 
---
= Utilisez des caractères génériques pour afficher des informations sur la sécurité des fichiers ONTAP et les stratégies d'audit
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
