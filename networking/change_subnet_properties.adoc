...
summary: 'Modifiez l"adresse du sous-réseau, la valeur du masque, l"adresse de la passerelle ou la plage d"adresses IP.' 
---
= Modifier les propriétés du sous-réseau ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
