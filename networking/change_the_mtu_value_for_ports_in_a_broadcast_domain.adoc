...
.System Manager
--
À partir de ONTAP 9.12.0, vous pouvez utiliser System Manager pour modifier la valeur MTU d'un domaine de diffusion afin de changer la valeur MTU de tous les ports de ce domaine de diffusion.
