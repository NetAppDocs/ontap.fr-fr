...
Pour en savoir plus, `network port ifgrp add-port` consultez le link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-add-port.html["Référence de commande ONTAP"^]. Pour en savoir plus, `network port ifgrp add-port` consultez le link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-add-port.html["Référence de commande ONTAP"^].
...
Pour en savoir plus, `network port ifgrp delete` consultez le link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-delete.html["Référence de commande ONTAP"^]. Pour en savoir plus, `network port ifgrp delete` consultez le link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-delete.html["Référence de commande ONTAP"^].
