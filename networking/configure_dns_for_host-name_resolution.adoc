...
summary: 'Utilisez DNS pour accéder aux sources locales ou distantes d"informations sur l"hôte.' 
---
= Configurer le DNS pour la résolution des noms d'hôtes sur ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
