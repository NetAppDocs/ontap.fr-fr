...
NOTE: Pour éviter un échec de configuration d'un nom de domaine complet (FQDN) SVM non conforme aux règles RFC pour les mises à jour DDNS, utilisez un nom de domaine complet conforme aux RFC. Pour plus d'informations, consultez link:https://tools.ietf.org/html/rfc1123["RFC 1123"^].
