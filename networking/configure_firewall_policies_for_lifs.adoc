...
Vous pouvez utiliser la commande network interface modify pour appliquer la politique de pare-feu à une LIF existante. Pour obtenir la syntaxe complète de la commande, reportez-vous à la https://docs.netapp.com/us-en/ontap-cli["Référence de commande ONTAP"^].
