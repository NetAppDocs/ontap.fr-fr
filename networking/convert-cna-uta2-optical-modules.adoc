...
summary: 'Vous devez modifier les modules optiques de l"adaptateur cible unifié pour qu"ils prennent en charge le mode de personnalité que vous avez sélectionné pour l"adaptateur.' 
---
