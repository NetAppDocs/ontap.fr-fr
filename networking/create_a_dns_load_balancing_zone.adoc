...
summary: 'Créez une zone d"équilibrage de charge DNS pour améliorer les performances LIF.' 
---
...
Lelink:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Storage_Software/ONTAP_OS/How_to_set_up_DNS_load_balancing_in_clustered_Data_ONTAP["Base de connaissances NetApp : Comment configurer l'équilibrage de charge DNS en mode cluster"^] contient plus d'informations sur la configuration de l'équilibrage de charge DNS à l'aide de la redirection conditionnelle.
