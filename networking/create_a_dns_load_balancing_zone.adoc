...
Si la zone d'équilibrage de charge existe déjà, le LIF le est ajouté. Pour plus d'informations sur la commande, reportez-vous à la section link:http://docs.netapp.com/us-en/ontap-cli["Référence de commande ONTAP 9"^].
