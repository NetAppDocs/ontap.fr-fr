...
summary: Créez des espaces IP pour chaque SVM dans un cluster. 
---
...
[NOTE]
====
À partir d'ONTAP 9.19.1, ONTAP améliore les performances de transfert de données TCP sur les liaisons WAN sujettes aux pertes et à une latence élevée en intégrant deux fonctionnalités de récupération des pertes dans la pile TCP d'ONTAP : PRR et RACK.link:improve-tcp-wan-performance.html["Découvrez comment améliorer les performances TCP WAN avec PRR et RACK"]
