...
Pour en savoir plus sur la commande link:http://docs.NetApp.com/US-en/ONTAP-cli/network-connections-active-show-clients.html[`network connections active show-clients`], consultez le document de référence sur les commandes ONTAP.
