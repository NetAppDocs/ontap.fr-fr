...
summary: Afficher toutes les connexions actives ou en écoute dans le cluster ou le nombre de connexions actives sur le nœud par client, LIF, protocole ou service. 
---
...
En savoir plus sur `network connections active show-protocols` dans le link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=network+connections+active+show-protocols["Référence de commande ONTAP"^].
