...
Pour plus d'informations sur cette commande, reportez-vous au link:http://docs.netapp.com/us-en/ontap-cli/network-connections-active-show-clients.html["Référence de commande ONTAP 9"^].
