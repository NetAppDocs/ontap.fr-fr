...
summary: Utilisez les protocoles de découverte de voisins pour visualiser la connectivité réseau entre une paire de systèmes physiques ou virtuels et leurs interfaces réseau. 
---
= Protocoles de découverte de voisins pour la connectivité réseau ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
