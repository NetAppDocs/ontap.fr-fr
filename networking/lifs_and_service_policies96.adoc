...
summary: Attribuez des stratégies de service aux LIF pour spécifier le trafic pris en charge. 
---
= Politiques de service ONTAP LIF
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
IMPORTANT: Les protocoles FCP et NVMe/FCP ne nécessitent actuellement pas de service-policy.
...
NOTE: Les applications qui se trouvent sur une LIF avec une politique de service vide peuvent se comporter de manière inattendue.
