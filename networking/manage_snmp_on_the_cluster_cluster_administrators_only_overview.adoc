...
summary: Configurez SNMP pour surveiller les SVM de votre cluster. 
---
...
Pour plus d'informations sur la prise en charge de SNMP dans les systèmes ONTAP, voir https://www.netapp.com/pdf.html?item=/media/16417-tr-4220.pdf["Tr-4220 : prise en charge SNMP dans Data ONTAP"^].
