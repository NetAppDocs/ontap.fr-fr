...
summary: 'La surveillance automatique de l"état et un ensemble de moniteurs de santé vous aident à identifier les ports réseau qui pourraient ne pas convenir à l"hébergement des LIF.' 
---
