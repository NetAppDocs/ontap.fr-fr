...
summary: Les domaines de diffusion, les groupes de basculement et les politiques de basculement fonctionnent ensemble pour déterminer quel port prendra le relais en cas de panne. 
---
= Fonctionnement des domaines de diffusion, des groupes de basculement et des stratégies ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
