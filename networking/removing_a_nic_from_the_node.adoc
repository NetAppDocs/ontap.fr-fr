...
summary: ONTAP 9.8 et versions ultérieures, retirez une carte NIC défectueuse de son emplacement ou déplacez la carte NIC vers un autre emplacement à des fins de maintenance. 
---
