...
summary: Si un port est recâblé ou si la configuration du commutateur change, il peut être nécessaire de réparer un port dans un domaine de diffusion différent, nouveau ou existant. 
---
