...
summary: Consultez et téléchargez les informations relatives aux ports, aux LIF, aux routes, aux règles de basculement, aux groupes de basculement, aux règles de pare-feu, au DNS, au NIS et aux connexions. 
---
= Informations réseau que vous pouvez consulter dans ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
