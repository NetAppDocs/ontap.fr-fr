...
summary: Remplissez toutes les sections de la feuille de calcul avant de configurer le basculement du chemin NAS pour ONTAP 9.8 et versions ultérieures. 
---
