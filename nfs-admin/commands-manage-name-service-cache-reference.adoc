...
summary: Vous pouvez gérer le cache du service de noms en modifiant la valeur de durée de vie. La valeur TTL détermine la durée pendant laquelle les informations du service de noms sont conservées dans le cache. 
---
