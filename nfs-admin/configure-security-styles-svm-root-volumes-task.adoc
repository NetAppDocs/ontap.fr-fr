...
summary: 'Vous configurez le style de sécurité du volume racine de la machine virtuelle de stockage pour déterminer le type d"autorisations utilisées pour les données sur le volume racine de la SVM.' 
---
