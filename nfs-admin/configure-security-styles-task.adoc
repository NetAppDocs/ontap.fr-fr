...
summary: 'Vous configurez le style de sécurité du volume FlexVol pour déterminer le type d"autorisations utilisées pour les données sur les volumes FlexVol de la machine virtuelle de stockage.' 
---
