...
summary: 'Vous pouvez configurer la durée pendant laquelle ONTAP conserve les informations d"identification des utilisateurs NFS dans son cache interne en modifiant le serveur NFS de la machine virtuelle de stockage. Cela permet d"atténuer certains problèmes liés à une charge élevée sur les serveurs de noms ou à des modifications d"informations d"identification affectant l"accès des utilisateurs NFS.' 
---
...
La durée de vie (TTL) est mesurée en millisecondes. À partir de ONTAP 9.17.1 et versions ultérieures, la valeur par défaut est de 1 heure (3 600 000 millisecondes). Dans ONTAP 9.16.1 et versions antérieures, la valeur par défaut est de 24 heures (86 400 000 millisecondes). La plage de valeurs autorisée va de 1 minute (60 000 millisecondes) à 7 jours (604 800 000 millisecondes).
