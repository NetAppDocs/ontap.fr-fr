...
summary: 'Vous pouvez activer ou désactiver l"accès NFS aux machines virtuelles de stockage via TCP et UDP en modifiant respectivement les paramètres -tcp et -udp. Cela vous permet de contrôler si les clients NFS peuvent accéder aux données via TCP ou UDP dans votre environnement.' 
---
