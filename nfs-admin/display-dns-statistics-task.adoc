...
summary: Vous pouvez afficher les statistiques DNS des machines virtuelles de stockage sur le système de stockage afin de surveiller les performances et de diagnostiquer les problèmes. 
---
