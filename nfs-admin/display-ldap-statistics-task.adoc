...
summary: Vous pouvez afficher les statistiques LDAP des machines virtuelles de stockage sur un système de stockage afin de surveiller les performances et de diagnostiquer les problèmes. 
---
