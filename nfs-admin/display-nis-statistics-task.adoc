...
summary: Vous pouvez afficher les statistiques NIS des machines virtuelles de stockage sur le système de stockage afin de surveiller les performances et de diagnostiquer les problèmes. 
---
