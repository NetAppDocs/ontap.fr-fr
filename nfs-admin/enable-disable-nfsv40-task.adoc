...
summary: 'Vous pouvez activer ou désactiver NFSv4.0 en modifiant l"option -v4.0. Cela permet l"accès aux fichiers pour les clients utilisant le protocole NFSv4.0. Dans ONTAP 9.9.1, NFSv4.0 est activé par défaut. Dans les versions antérieures, il est désactivé par défaut.' 
---
