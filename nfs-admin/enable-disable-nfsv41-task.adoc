...
summary: 'Vous pouvez activer ou désactiver NFSv4.1 en modifiant l"option -v4.1. Cela permet l"accès aux fichiers pour les clients utilisant le protocole NFSv4.1. Dans ONTAP 9.9.1, NFSv4.1 est activé par défaut. Dans les versions antérieures, il est désactivé par défaut.' 
---
