...
summary: 'pNFS améliore les performances en permettant aux clients NFS d"effectuer des opérations de lecture/écriture directement et en parallèle sur les périphériques de stockage, en contournant le serveur NFS qui pourrait constituer un goulot d"étranglement. Pour activer ou désactiver pNFS, vous pouvez modifier l"option -v4.1-pnfs.' 
---
