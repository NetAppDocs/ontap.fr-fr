...
summary: 'Le protocole de quota distant permet aux clients NFS d"obtenir les informations de quota des utilisateurs depuis une machine distante. La prise en charge des versions de rquota varie selon votre version d"ONTAP.' 
---
