...
summary: 'Vous pouvez activer ou désactiver la prise en charge de VMware vStorage over NFS sur les machines virtuelles de stockage à l"aide de la commande vserver nfs modify.' 
---
