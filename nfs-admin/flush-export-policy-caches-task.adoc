...
summary: 'La suppression manuelle des caches de règles d"export permet d"éliminer les informations potentiellement obsolètes et force ONTAP à récupérer les informations à jour auprès des ressources externes appropriées. Cela peut aider à résoudre divers problèmes liés à l"accès des clients aux exports NFS.' 
---
