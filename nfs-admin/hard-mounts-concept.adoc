...
summary: 'Lors du dépannage des problèmes de montage, assurez-vous d"utiliser le type de montage approprié. NFS prend en charge deux types de montage : les montages souples et les montages rigides. Pour des raisons de fiabilité, utilisez uniquement des montages rigides.' 
---
