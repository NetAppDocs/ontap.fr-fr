...
summary: 'À partir de ONTAP 9.11.1, vous pouvez tirer parti de la fonctionnalité _fast bind_ LDAP pour des demandes d"authentification de clients plus rapides et plus simples. Pour utiliser cette fonctionnalité, le serveur LDAP doit prendre en charge la fonctionnalité fast bind.' 
---
