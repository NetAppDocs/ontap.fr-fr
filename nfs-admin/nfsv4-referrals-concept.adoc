...
summary: 'Lorsque vous activez les redirections NFSv4, ONTAP fournit des redirections intra-SVM aux clients NFSv4. Une redirection intra-SVM se produit lorsqu"un nœud de cluster recevant la requête NFSv4 redirige le client NFSv4 vers une autre interface logique sur la machine virtuelle de stockage.' 
---
