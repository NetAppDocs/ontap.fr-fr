...
summary: 'Pour spécifier la durée du bail de verrouillage NFSv4, vous pouvez modifier l"option -v4-lease-seconds. Des durées de bail plus courtes accélèrent la récupération du serveur, tandis que des durées plus longues sont avantageuses pour les serveurs gérant un très grand nombre de clients.' 
---
