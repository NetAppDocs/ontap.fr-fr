...
BONNES PRATIQUES : Il convient d’utiliser NFSv4.1 ou NFSv4.2 plutôt que NFSv4.0. NFSv4.0 est une version plus ancienne du protocole NFS et n’est plus activement développée par la communauté NFS.
