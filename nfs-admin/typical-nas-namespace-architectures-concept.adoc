...
image::../media/namespace-architecture-with-single-branched-tree.gif[architecture de l'espace de noms avec une seule arborescence ramifiée]
...
image::../media/namespace-architecture-with-multiple-branched-trees.png[architecture de l'espace de noms avec plusieurs arborescences ramifiées]
...
image::../media/namespace-architecture-with-multiple-standalone-volumes.gif[architecture d'espace de noms avec plusieurs volumes autonomes]
