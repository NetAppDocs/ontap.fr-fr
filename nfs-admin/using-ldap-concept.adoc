...
sidebar: sidebar 
keywords: use, ldap 
summary: 'Un serveur LDAP vous permet de gérer de manière centralisée les informations des utilisateurs. Si vous stockez votre base de données des utilisateurs sur un serveur LDAP dans votre environnement, vous pouvez configurer votre système de stockage pour qu"il recherche les informations des utilisateurs dans votre base de données LDAP existante.' 
---
...
Pour plus d'informations, voir https://www.netapp.com/pdf.html?item=/media/19423-tr-4835.pdf["Rapport technique NetApp 4835 : comment configurer LDAP dans ONTAP"^].
