...
summary: 'Si un service d"information réseau est utilisé dans votre environnement pour les services de noms, vous devez créer une configuration de domaine NIS pour la SVM en utilisant la commande vserver services name-service nis-domain create.' 
---
