...
summary: 'Au lieu de créer manuellement des utilisateurs UNIX locaux individuels dans les SVM, vous pouvez simplifier la tâche en chargeant une liste d"utilisateurs UNIX locaux dans les SVM à partir d"un identifiant de ressource uniforme.' 
---
