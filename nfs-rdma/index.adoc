...
* Les clients doivent utiliser des cartes réseau compatibles RDMA Mellanox et le logiciel réseau MOFED (Mellanox OFED). Pour plus d'informations sur la prise en charge de link:https://hwu.netapp.com/["NetApp Hardware Universe"^]la carte, reportez-vous au . Les adaptateurs pris en charge par NFS sur RDMA affichent « RoCE » dans le champ de description.
