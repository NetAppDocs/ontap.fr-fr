...
summary: 'À partir d"ONTAP 9.14.1, les clients NFS exécutant la version 4.1 ou ultérieure peuvent tirer parti de la fonctionnalité de session trunking pour ouvrir plusieurs connexions au serveur NFS, augmentant ainsi la vitesse de transfert de données et assurant la résilience grâce au multipathing.' 
---
