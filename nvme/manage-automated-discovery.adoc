...
summary: 'À partir d"ONTAP 9.13.1, la découverte des hôtes des contrôleurs utilisant le protocole NVMe TCP est automatisée par défaut dans les infrastructures basées sur IP.' 
---
