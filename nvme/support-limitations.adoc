...
+
Les protocoles SCSI, NAS et NVMe peuvent coexister sur la même machine virtuelle de stockage (SVM). Si le système d'exploitation hôte ne prend pas en charge la coexistence des protocoles, vous devez configurer des SVM distinctes pour chaque protocole pris en charge par l'hôte.
