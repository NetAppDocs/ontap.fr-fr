...
Pour plus de détails sur la configuration de NTP dans ONTAP, reportez-vous à la section link:https:../system-admin/manage-cluster-time-concept.html["Gestion de l'heure du cluster (administrateurs du cluster uniquement)"].
