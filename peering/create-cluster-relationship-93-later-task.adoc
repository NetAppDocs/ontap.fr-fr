...
summary: 'Vous pouvez utiliser la commande cluster peer create ou System Manager pour créer une relation entre pairs entre clusters locaux et distants. Une fois la relation homologue créée, vous pouvez répéter la tâche sur le cluster distant pour l"authentifier auprès du cluster local.' 
---
...
. Dans la section *intercluster Settings*, cliquez sur *Add Network interfaces* et ajoutez les interfaces réseau intercluster du cluster.
+
