...
summary: Bien que vous deviez conserver les mêmes paramètres MTU sur vos clients, serveurs et systèmes de stockage, les périphériques réseau intermédiaires tels que les cartes réseau et les commutateurs doivent être configurés sur leurs valeurs MTU maximales afin de garantir que les performances ne soient pas affectées. 
---
