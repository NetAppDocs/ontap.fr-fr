...
summary: 'Pour installer le logiciel, vous devez télécharger le fichier d"installation de l"appliance virtuelle, puis utiliser un client VMware vSphere pour déployer ce fichier sur un serveur VMware ESXi. L"appliance virtuelle est disponible sous forme de fichier OVA.' 
---
