...
+
`_storage_object_ create -vserver _SVM_ -qos-policy-group _policy_group_`Vous pouvez utiliser le `_storage_object_modify` commande pour appliquer un groupe de politiques différent à l'objet de stockage.
