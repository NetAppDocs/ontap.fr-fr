...
summary: 'Après avoir configuré un cluster, vous pouvez utiliser soit System Manager, soit l"interface de ligne de commande ONTAP pour continuer à configurer le cluster.' 
---
