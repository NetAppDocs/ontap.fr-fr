...
| Protection autonome contre les ransomwares (ARP) | ARP/AI est automatiquement activé par défaut sur tous les nouveaux volumes après un délai de grâce de 12 heures sur les plateformes prises en charge. | ONTAP 9.18.1 
