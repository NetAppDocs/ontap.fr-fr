...
+
Étend la protection autonome contre les ransomwares (ARP/AI) à SnapMirror synchronous (SAN et NAS) et aux environnements SAN SnapMirror active sync, en préservant les signaux de détection et de récupération dans les architectures à RPO zéro. 
