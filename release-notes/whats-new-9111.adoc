...
| Dans l'API REST ONTAP, les groupes de cohérence prennent en charge une procédure d'instantané en deux phases, vous permettant d'effectuer une vérification préalable avant de valider l'instantané. 
|===
