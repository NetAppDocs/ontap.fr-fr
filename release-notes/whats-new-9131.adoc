...
* xref:../anti-ransomware/support-arpai.html#multi-admin-verification-with-arp-ai-protected-volumes[Fonctionnalité de vérification multiadministrateur avec la protection anti-ransomware autonome]
...
À partir d' ONTAP 9.12.1, System Manager est intégré à la console NetApp . En savoir plus sur xref:../concepts/sysmgr-integration-console-concept.html[Intégration de System Manager avec NetApp Console] .
