...
À partir d' ONTAP 9.12.1, System Manager est intégré à la console NetApp . En savoir plus sur xref:../sysmgr-integration-console-concept.html[Intégration de System Manager avec NetApp Console] .
