...
| Mise à jour | Description 
 ...
 a| 
xref:../authentication-access-control/webauthn-mfa-overview.html[Prise en charge de l'authentification multifactorielle résistante au phishing WebAuthn dans System Manager]
 a| 
