...
| Mise à jour | Description 
 ...
 a| 
xref:../snapmirror-active-sync/[Prise en charge de plusieurs nœuds pour la synchronisation active SnapMirror]
 a| 
