...
À partir d'ONTAP 9.17.1P5, la protection autonome contre les ransomwares prend en charge les hyperviseurs Hyper-V, KVM et OpenStack.
 ...
 a| 
xref:../anti-ransomware/index.html[Mises à jour des snapshots de la protection autonome contre les ransomwares]
 a| 
ONTAP introduit plusieurs mises à jour concernant les instantanés ARP/AI.
