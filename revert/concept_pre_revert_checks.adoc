...
| ONTAP 9.18.1  a| 
* Si l'activation automatique a été configurée pour ARP dans le cadre d'une mise à niveau ONTAP 9.18.1, vous devrez link:anti-ransomware-disable-auto-enable.html["désactivez-le"].
