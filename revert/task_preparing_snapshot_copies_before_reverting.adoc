...
+
Pour plus d'informations sur la suppression des relations de partage de charge, consultez link:https://kb.netapp.com/on-prem/ontap/DP/SnapMirror/SnapMirror-KBs/How_to_remove_a_load-sharing_LS_mirror_relationship["Comment supprimer une relation de miroir de partage de charge"].
