...
+
Le `-version` l'option fait référence à la version ONTAP vers laquelle vous revenez.  Par exemple, si vous revenez de la version 9.14 à la version 9.13, la valeur correcte du `-version` l'option est 9.13.
