...
. Recommencez  à  Sur l'autre nœud de la paire HA.
...
. Recommencez  à  Pour chaque paire haute disponibilité supplémentaire et les deux clusters dans la configuration MetroCluster.
