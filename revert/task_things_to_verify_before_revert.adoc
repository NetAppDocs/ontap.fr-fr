...
summary: 'Avant de rétablir ONTAP, vous devez vérifier l"état de votre cluster, l"état du stockage et l"heure système. Vous devez également vérifier qu"aucune tâche n"est en cours d"exécution sur le cluster.' 
---
...
** Le quorum primaire par anneau doit être le même pour tous les nœuds.
+
Notez que chaque anneau peut avoir un quorum primaire différent.
