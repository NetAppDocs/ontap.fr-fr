...
La capacité minimale du seau est déterminée par la plateforme ONTAP .

* 95 Go pour les plateformes sur site.
* 1,6 Go pour Lab on Demand.
* 200 Mo pour ONTAP Select.
...
La capacité maximale du godet est limitée à la taille maximale du FlexGroup de 60PB.



=== Nombre maximal de seaux

Le nombre maximal de compartiments est de 1000 par volume FlexGroup , ou de 12 000 compartiments par cluster (en utilisant 12 volumes FlexGroup ).
