...
[role="lead"]
Dans ONTAP, l'architecture sous-jacente d'un compartiment est un link:https://docs.netapp.com/us-en/ontap/flexgroup/definition-concept.html["Volume FlexGroup"]--un namespace unique composé de plusieurs volumes de membres constitutifs, mais géré comme un seul volume.
