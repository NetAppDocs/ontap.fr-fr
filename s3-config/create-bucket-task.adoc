...
Pour plus d'informations sur les définitions de service de stockage, reportez-vous à la section link:storage-service-definitions-reference.html["Définitions des services de stockage"]
...
Pour plus d'informations sur la gestion des performances, reportez-vous à la section link:../performance-admin/index.html["Gestion des performances"]
...
.Exemple
L'exemple suivant crée un compartiment pour la VM de stockage vs1 de 1 To avec la spécification de l'agrégat :
...
Sur les applications client S3 (ONTAP S3 ou une application externe 3^rd^), vous pouvez vérifier votre accès au nouveau compartiment en saisissant les informations suivantes :
