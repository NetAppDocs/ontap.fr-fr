...
----
À partir d'ONTAP 9.19.1, vous pouvez utiliser des conditions pour imposer des écritures conditionnelles lors du chargement d'objets et des suppressions conditionnelles lors de la suppression d'objets. L'exemple suivant crée une condition de stratégie de compartiment pour imposer des écritures conditionnelles pour le compartiment bucket1 :
