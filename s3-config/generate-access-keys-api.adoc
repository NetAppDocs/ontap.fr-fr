...
----
+
Pour en savoir plus sur la commande link:https://docs.NetApp.com/US-en/ONTAP-cli/security-login-rest-role-create.html[`security login rest-role create`], consultez le document de référence sur les commandes ONTAP.

. Créez un groupe d'utilisateurs LDAP avec la commande Security login et ajoutez le nouveau rôle personnalisé pour accéder au point final de l'API REST de l'utilisateur S3. Pour en savoir plus sur la commande link:https://docs.NetApp.com/US-en/ONTAP-cli//security-login-create.html[`security login create`], consultez le document de référence sur les commandes ONTAP.
+
[listing]
----
