...
+
.. Cliquez sur *Stockage > Machines virtuelles de stockage*, sélectionnez une machine virtuelle de stockage compatible NAS, cliquez sur *Paramètres*, puis sous *Protocoles > S3*, cliquez sur image:icon_gear.gif["Icône actions"] sous S3.
...
. Activez S3 sur une machine virtuelle de stockage avec les protocoles NAS configurés.
+
.. Cliquez sur *Cluster > Machines virtuelles de stockage*, sélectionnez une machine virtuelle de stockage compatible NAS, cliquez sur *Paramètres*, puis sous *Protocoles > S3*, cliquez sur image:icon_gear.gif["Icône actions"].
.. Sélectionnez le type de certificat. Que vous sélectionniez un certificat généré par le système ou l'un de vos propres certificats, il sera nécessaire d'accéder au client.
.. Saisissez les interfaces réseau.
...
+
** La clé secrète ne s'affiche plus.
** Si vous avez à nouveau besoin des informations du certificat : cliquez sur *Cluster > Storage VMs*, sélectionnez la Storage VM, puis cliquez sur *Paramètres*.
