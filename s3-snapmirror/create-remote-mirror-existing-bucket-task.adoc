...
summary: 'Vous pouvez commencer à protéger les compartiments S3 existants à tout moment, par exemple si vous avez mis à niveau une configuration S3 à partir d"une version antérieure à ONTAP 9.10.1.' 
---
