...
. Sélectionnez *Activer NVMe/FC* ou *Activer NVMe/TCP*.
. Si vous activez NVMe/TCP et que vous souhaitez que les chemins réseau basculent automatiquement vers le partenaire HA en cas de panne d'un nœud, procédez comme suit :
+
