...
summary: 'À partir d"ONTAP 9.10.1, vous pouvez utiliser System Manager pour attribuer ou supprimer des règles de qualité de service sur plusieurs LUN simultanément.' 
---
