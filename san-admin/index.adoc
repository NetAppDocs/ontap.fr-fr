...
.Pour en savoir plus
Si vous disposez d'un système de stockage ASA r2 (ASA A1K, ASA A90, ASA A70, ASA A50, ASA A30 ou ASA A20), consultez le link:https://docs.netapp.com/us-en/asa-r2/index.html["Documentation du système de stockage ASA r2"^].
