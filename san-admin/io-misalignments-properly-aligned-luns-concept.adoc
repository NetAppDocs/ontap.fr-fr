...
* https://["Utilitaires d'hôtes unifiés Windows 7.1"]
* https://["Guide d'installation et d'administration de Virtual Storage Console pour VMware vSphere"^]
...
Voir la http://["Solaris Host Utilities - Guide d'installation et d'administration"^] pour des informations détaillées.
...
https://["Alignement des partitions/disques du système de fichiers des machines virtuelles invité pour VMware vSphere, les autres environnements virtuels et les systèmes de stockage NetApp"]
