...
summary: Vous pouvez gérer la disponibilité du service iSCSI sur les interfaces logiques iSCSI de la machine virtuelle de stockage en utilisant les commandes vserver iscsi interface enable ou vserver iscsi interface disable. 
---
