...
summary: 'Les baies SAN 100% Flash NetApp sont disponibles à partir d"ONTAP 9.7. Les ASA sont des solutions SAN 100% Flash construites sur les plateformes AFF NetApp éprouvées.' 
---
...
* link:https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf["Rapport technique de NetApp 4080 : meilleures pratiques pour le SAN moderne"^]
