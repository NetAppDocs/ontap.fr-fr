...
summary: Vous pouvez utiliser le protocole non-volatile memory express pour fournir du stockage dans un environnement SAN. Le protocole NVMe est optimisé pour les performances avec le stockage SSD. 
---
