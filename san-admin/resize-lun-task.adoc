...
Pour en savoir plus sur la commande link:https://docs.NetApp.com/US-en/ONTAP-cli//lun-resize.html#description[`lun resize`^], consultez la référence de commande ONTAP.
