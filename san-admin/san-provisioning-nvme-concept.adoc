...
summary: 'À partir d"ONTAP 9.4, NVMe FC est pris en charge dans les environnements SAN. NVMe FC permet aux administrateurs de stockage de provisionner des espaces de noms et des sous-systèmes, puis d"associer les espaces de noms aux sous-systèmes, de la même manière que les LUN sont provisionnés et associés aux igroups pour FC et iSCSI.' 
---
...
https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["Rapport technique NetApp 4684 : implémentation et configuration des SAN modernes avec NVMe/FC"^]
