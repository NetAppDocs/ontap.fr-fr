...
Suivez les instructions de la documentation des Host Utilities pour obtenir les WWPN et trouver les noms des nœuds iSCSI associés à un hôte spécifique. Pour les hôtes exécutant le logiciel ESX, utilisez ONTAP tools for VMware vSphere.
