...
Pour plus d'informations sur les ports persistants, voir link:https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf["Rapport technique de NetApp 4080 : meilleures pratiques pour le SAN moderne"^].
