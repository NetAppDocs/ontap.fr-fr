...
image::../media/scrn-en-drw-fcoe-dual-2p-targ.png[Initiateur FCoE sur la cible FC]
...
image::../media/scrn_en_drw_ip_storage_protocol.png[FCoE combiné avec les protocoles de stockage IP]
