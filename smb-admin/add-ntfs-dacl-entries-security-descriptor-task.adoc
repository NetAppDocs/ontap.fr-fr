...
summary: 'L"ajout d"entrées de contrôle d"accès DACL au descripteur de sécurité NTFS constitue la deuxième étape de la configuration et de l"application des ACL NTFS à un fichier ou un dossier. Chaque entrée identifie quel objet est autorisé ou refusé l"accès, et définit ce que l"objet peut ou ne peut pas faire aux fichiers ou dossiers définis dans l"ACE.' 
---
