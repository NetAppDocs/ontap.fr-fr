...
summary: 'L"ajout d"entrées de contrôle d"accès SACL au descripteur de sécurité NTFS est la deuxième étape de la création de règles d"audit NTFS pour les fichiers ou dossiers dans les SVM. Chaque entrée identifie l"utilisateur ou le groupe que vous souhaitez auditer. L"entrée SACL définit si vous souhaitez auditer les tentatives d"accès réussies ou échouées.' 
---
