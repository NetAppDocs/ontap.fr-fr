...
summary: Vous pouvez modifier la clé du serveur BranchCache en modifiant la configuration BranchCache sur la machine virtuelle de stockage et en spécifiant une clé de serveur différente. 
---
