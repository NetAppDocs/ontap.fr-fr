...
summary: 'Il existe des commandes ONTAP spécifiques pour gérer les entrées de contrôle d"accès DACL. Vous pouvez ajouter des ACE aux DACL NTFS à tout moment. Vous pouvez également gérer les DACL NTFS existantes en modifiant, supprimant et affichant des informations sur les ACE dans les DACL.' 
---
