...
summary: 'Il existe des commandes ONTAP spécifiques pour gérer les entrées de contrôle d"accès SACL. Vous pouvez ajouter des ACE aux SACL NTFS à tout moment. Vous pouvez également gérer les SACL NTFS existantes en modifiant, supprimant et affichant les informations relatives aux ACE dans les SACL.' 
---
