...
summary: 'Vous devez connaître les commandes permettant de gérer les listes de contrôle d"accès SMB, notamment leur création, leur affichage, leur modification et leur suppression.' 
---
