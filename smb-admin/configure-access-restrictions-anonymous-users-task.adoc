...
summary: 'Par défaut, un utilisateur anonyme non authentifié peut accéder à certaines informations sur le réseau. Vous pouvez utiliser une option du serveur SMB pour configurer des restrictions d"accès pour l"utilisateur anonyme.' 
---
