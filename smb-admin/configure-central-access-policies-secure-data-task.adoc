...
summary: 'Plusieurs étapes sont nécessaires pour sécuriser l"accès aux données sur le serveur CIFS à l"aide de règles d"accès centralisées, notamment l"activation du contrôle d"accès dynamique sur le serveur CIFS, la configuration des règles d"accès centralisées dans Active Directory, l"application des règles d"accès centralisées aux conteneurs Active Directory avec des GPO et l"activation des GPO sur le serveur CIFS.' 
---
