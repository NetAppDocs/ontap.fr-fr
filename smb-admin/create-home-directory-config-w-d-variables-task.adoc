...
summary: 'Vous pouvez créer une configuration de répertoire local à l"aide du nom d"utilisateur Windows et des variables de répertoire local. Les utilisateurs peuvent ensuite se connecter à leur partage personnel à l"aide de partages créés dynamiquement.' 
---
