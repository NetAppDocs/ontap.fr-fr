...
summary: 'Configurer les autorisations de partage en créant des listes de contrôle d"accès pour les partages SMB vous permet de contrôler le niveau d"accès à un partage pour les utilisateurs et les groupes.' 
---
