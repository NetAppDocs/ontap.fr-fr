...
summary: Lorsque vous créez un serveur CIFS sur votre machine virtuelle de stockage, des partages administratifs par défaut sont automatiquement créés. Vous devez comprendre quels sont ces partages par défaut et comment ils sont utilisés. 
---
