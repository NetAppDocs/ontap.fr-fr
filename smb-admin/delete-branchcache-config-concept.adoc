...
summary: Si vous avez précédemment configuré BranchCache mais que vous ne souhaitez plus que la machine virtuelle de stockage continue de fournir du contenu mis en cache, vous pouvez supprimer la configuration BranchCache sur le serveur CIFS. Vous devez savoir ce qui se passe lorsque vous supprimez la configuration. 
---
