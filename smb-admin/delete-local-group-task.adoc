...
summary: 'Vous pouvez supprimer un groupe local de la machine virtuelle de stockage s"il n"est plus nécessaire pour déterminer les droits d"accès aux données associées à cette SVM ou s"il n"est plus nécessaire pour attribuer des droits d"utilisateur SVM aux membres du groupe.' 
---
