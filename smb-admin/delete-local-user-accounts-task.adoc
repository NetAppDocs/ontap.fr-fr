...
summary: 'Vous pouvez supprimer les comptes d"utilisateurs locaux de votre machine virtuelle de stockage s"ils ne sont plus nécessaires pour l"authentification SMB locale auprès du serveur CIFS ou pour la détermination des droits d"accès aux données contenues sur votre SVM.' 
---
