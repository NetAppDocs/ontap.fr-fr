...
À partir de ONTAP 9.13.1, ONTAP effectue également la découverte de site pour les domaines de confiance et utilise le site découvert pour localiser les contrôleurs de domaine de ces domaines. Cela permet de garantir que les requêtes DNS SRV utilisent les informations de site correctes pour les contrôleurs de domaine des domaines de confiance. Si la découverte de site pour un domaine de confiance échoue, ONTAP revient au site par défaut du serveur SMB.
