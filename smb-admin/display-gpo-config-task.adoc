...
summary: Vous pouvez afficher des informations sur les configurations des objets de stratégie de groupe définies dans Active Directory et sur les configurations GPO appliquées au serveur CIFS. 
---
