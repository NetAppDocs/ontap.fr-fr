...
summary: 'Vous pouvez afficher la liste de tous les membres des groupes locaux configurés sur le cluster ou sur une machine virtuelle de stockage spécifique. Ces informations peuvent s"avérer utiles pour résoudre les problèmes d"accès aux fichiers ou les problèmes de droits d"utilisateur.' 
---
