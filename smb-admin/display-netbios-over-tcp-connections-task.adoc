...
summary: 'Vous pouvez afficher des informations sur NetBIOS via les connexions TCP. Cela peut s"avérer utile pour le dépannage des problèmes liés à NetBIOS.' 
---
