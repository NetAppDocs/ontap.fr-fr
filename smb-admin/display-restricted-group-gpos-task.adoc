...
summary: Vous pouvez afficher des informations détaillées sur les groupes restreints définis comme objets de stratégie de groupe dans Active Directory et qui sont appliqués au serveur CIFS. 
---
