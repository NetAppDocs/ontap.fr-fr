...
summary: Vous pouvez afficher des informations sur les paramètres de sécurité du serveur SMB sur vos machines virtuelles de stockage. Ces informations vous permettent de vérifier que les paramètres de sécurité sont corrects. 
---
