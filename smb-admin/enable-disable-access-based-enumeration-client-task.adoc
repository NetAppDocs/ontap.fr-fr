...
summary: 'Vous pouvez activer ou désactiver l"énumération basée sur l"accès sur les partages SMB à partir d"un client Windows, ce qui vous permet de configurer ce paramètre de partage sans avoir besoin de vous connecter au serveur CIFS.' 
---
