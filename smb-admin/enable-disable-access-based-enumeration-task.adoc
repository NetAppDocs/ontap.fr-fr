...
summary: 'Vous pouvez activer ou désactiver l"énumération basée sur le contrôle d"accès sur les partages SMB afin d"autoriser ou d"empêcher les utilisateurs de voir les ressources partagées auxquelles ils n"ont pas l"autorisation d"accéder.' 
---
