...
summary: 'Vous pouvez activer ou désactiver les règles d"accès pour l"accès SMB aux machines virtuelles de stockage. L"utilisation de règles d"accès pour contrôler l"accès SMB aux ressources est facultative.' 
---
