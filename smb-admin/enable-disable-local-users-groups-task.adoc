...
summary: 'Vous pouvez activer ou désactiver les utilisateurs et groupes locaux pour l"accès SMB sur les machines virtuelles de stockage. La fonctionnalité des utilisateurs et groupes locaux est activée par défaut.' 
---
