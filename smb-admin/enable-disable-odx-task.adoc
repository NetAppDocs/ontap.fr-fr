...
summary: Vous pouvez activer ou désactiver ODX sur les machines virtuelles de stockage. Par défaut, la prise en charge du déchargement de copie ODX est activée si SMB 3.0 est également activé. 
---
