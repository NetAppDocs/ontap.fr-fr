...
summary: 'Veillez à attribuer des noms d"utilisateur uniques lors de la création de partages de répertoire local à l"aide des variables de nom d"utilisateur Windows ou UNIX pour générer dynamiquement les partages. Le nom du partage est associé à votre nom d"utilisateur.' 
---
