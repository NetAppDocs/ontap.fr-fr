...
summary: 'ONTAP crée et conserve deux noms pour les fichiers ou répertoires dans tout répertoire accessible depuis un client SMB : le nom long d"origine et un nom au format 8.3.' 
---
