...
summary: 'Le transfert de données déchargé de Microsoft, également appelé déchargement de copie, permet des transferts de données directs au sein ou entre des périphériques de stockage compatibles sans transférer les données via l"ordinateur hôte.' 
---
