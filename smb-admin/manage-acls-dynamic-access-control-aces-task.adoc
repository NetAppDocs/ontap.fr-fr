...
summary: 'Si vous avez des ressources auxquelles des ACL sont appliquées avec des ACE de contrôle d"accès dynamique et que vous désactivez le contrôle d"accès dynamique sur la machine virtuelle de stockage, vous devez supprimer les ACE de contrôle d"accès dynamique avant de pouvoir gérer les ACE de contrôle d"accès non dynamique sur cette ressource.' 
---
