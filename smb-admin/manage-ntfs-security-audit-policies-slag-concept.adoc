...
summary: 'Vous pouvez gérer la sécurité des fichiers NTFS, les règles d"audit NTFS et Storage-Level Access Guard sur les machines virtuelles de stockage à l"aide de la ligne de commandes (CLI).' 
---
