...
summary: 'Si vous souhaitez mettre à jour immédiatement les paramètres des objets de règles d"accès sur votre serveur CIFS, vous pouvez mettre à jour manuellement les paramètres. Vous pouvez mettre à jour uniquement les paramètres modifiés ou forcer une mise à jour de tous les paramètres, y compris ceux qui ont été appliqués précédemment mais qui n"ont pas changé.' 
---
