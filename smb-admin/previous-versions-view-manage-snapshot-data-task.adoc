...
summary: 'Les utilisateurs de machines clientes Windows peuvent utiliser l"onglet Versions précédentes de la fenêtre Propriétés Windows pour restaurer les données stockées dans des instantanés sans avoir besoin de faire intervenir l"administrateur de la machine virtuelle de stockage.' 
---
