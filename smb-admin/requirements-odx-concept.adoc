...
summary: Avant de pouvoir utiliser ODX pour le déchargement de copies avec votre machine virtuelle de stockage, vous devez prendre connaissance de certaines exigences. 
---
