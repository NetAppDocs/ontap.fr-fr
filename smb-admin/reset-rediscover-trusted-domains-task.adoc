...
À partir de ONTAP 9.13.1, lorsque ONTAP redécouvre des domaines de confiance, il effectue également une découverte de site pour ces domaines de confiance. ONTAP utilise les informations de site découvertes pour les recherches de contrôleurs de domaine des domaines de confiance. Cela permet de garantir que les recherches DNS SRV utilisent les informations de site correctes pour les contrôleurs de domaine des domaines de confiance. Si la découverte de site d’un domaine de confiance échoue, ONTAP utilise le site par défaut du serveur SMB.
