...
summary: 'Vous devez être conscient de ce qui se passe lorsque vous revenez à une version d"ONTAP qui ne prend pas en charge le contrôle d"accès dynamique et de ce que vous devez faire avant et après cette restauration.' 
---
