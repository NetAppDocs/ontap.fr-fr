...
summary: 'Vous pouvez activer et configurer des serveurs SMB sur des machines virtuelles de stockage pour permettre aux clients SMB d"accéder aux fichiers de votre cluster.' 
---
