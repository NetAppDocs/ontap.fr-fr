...
summary: 'La signature SMB contribue à garantir que le trafic réseau entre le serveur SMB et le client n"est pas compromis. Elle le fait en empêchant les attaques par rejeu. Par défaut, ONTAP prend en charge la signature SMB lorsqu"elle est demandée par le client. L"administrateur de stockage peut, en option, configurer le serveur SMB pour exiger la signature SMB.' 
---
