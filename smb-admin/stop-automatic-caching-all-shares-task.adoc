...
summary: Si votre configuration BranchCache active automatiquement la mise en cache sur tous les partages SMB de chaque machine virtuelle de stockage, vous pouvez modifier la configuration BranchCache pour arrêter la mise en cache automatique du contenu pour tous les partages SMB. 
---
