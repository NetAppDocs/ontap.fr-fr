...
summary: 'Si vous souhaitez utiliser le contrôle d"accès dynamique sur votre serveur CIFS, vous devez comprendre comment ONTAP prend en charge la fonctionnalité de contrôle d"accès dynamique dans les environnements Active Directory.' 
---
