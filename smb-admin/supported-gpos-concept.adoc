...
summary: 'Bien que tous les objets de stratégie de groupe ne soient pas applicables à vos machines virtuelles de stockage compatibles CIFS, les SVM peuvent reconnaître et traiter l"ensemble pertinent des GPO.' 
---
