...
summary: Le protocole Server Message Block est un protocole de partage de fichiers distant utilisé par les clients et serveurs Microsoft Windows. Toutes les versions de SMB sont prises en charge. Vous devez vérifier que le serveur SMB ONTAP prend en charge les clients et la fonctionnalité requis dans votre environnement. 
---
