...
summary: 'La protection d"accès au niveau du stockage offre une sécurité renforcée au niveau du stockage, invisible côté client. Par conséquent, aucun utilisateur ni administrateur ne peut la révoquer depuis son poste de travail. Il existe certains cas d"utilisation où la capacité de contrôler l"accès au niveau du stockage est bénéfique.' 
---
