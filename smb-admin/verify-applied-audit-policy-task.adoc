...
summary: 'Vous pouvez vérifier la politique d"audit pour confirmer que les fichiers ou dossiers de la machine virtuelle de stockage à laquelle vous avez appliqué la politique de sécurité possèdent les paramètres de sécurité d"audit souhaités.' 
---
