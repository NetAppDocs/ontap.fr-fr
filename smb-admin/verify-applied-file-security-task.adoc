...
summary: Vous pouvez vérifier les paramètres de sécurité des fichiers pour confirmer que les fichiers ou dossiers de la machine virtuelle de stockage à laquelle vous avez appliqué la stratégie de sécurité possèdent les paramètres souhaités. 
---
