...
summary: 'Vous pouvez vérifier les paramètres de sécurité des fichiers pour confirmer que les fichiers ou les dossiers de la machine virtuelle de stockage (SVM) à laquelle vous avez appliqué la stratégie de sécurité disposent des paramètres souhaités.' 
---
= Vérifier la sécurité des fichiers SMB ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Étape
. Afficher les paramètres de sécurité des fichiers et dossiers : `vserver security file-directory show -vserver vserver_name -path path [-expand-mask true]`
+
