...
| System Manager Classic (disponible avec ONTAP 9.7 et versions antérieures) | link:https://docs.netapp.com/us-en/ontap-sm-classic/smb-config/index.html["Présentation de la configuration SMB"^] 
|===