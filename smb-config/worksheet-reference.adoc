...
`-default-site`
 a| 
Facultatif : à partir de ONTAP 9.13.1, le site par défaut est utilisé si une LIF n’a pas d’appartenance à un site et comme solution de secours si la découverte du site du domaine approuvé échoue.
 a| 
