...
|===
+
Pour en savoir plus, `statistics catalog` consultez le link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=statistics+catalog["Référence de commande ONTAP"^].
