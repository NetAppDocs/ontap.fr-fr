...
* link:https://docs.netapp.com/us-en/ontap-cli/statistics-show.html["statistiques affichées"^]
* link:https://docs.netapp.com/us-en/ontap-cli/statistics-start.html["début des statistiques"^]
* link:https://docs.netapp.com/us-en/ontap-cli/statistics-stop.html["fin des statistiques"^]
