...
Pour plus d'informations sur la technologie ONTAP et son interaction avec les services externes, consultez ces rapports techniques (TR) : ** https://www.netapp.com/pdf.html?item=/media/16334-tr-4172.pdf["Rapport technique de NetApp 4172 : Microsoft Hyper-V sur SMB 3.0 avec les meilleures pratiques de ONTAP"^]
