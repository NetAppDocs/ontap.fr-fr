...
summary: 'Les fonctionnalités d"ONTAP vous permettent d"activer des opérations non perturbatrices pour deux applications Microsoft via le protocole SMB : Microsoft Hyper-V et Microsoft SQL Server.' 
---
...
Pour plus d'informations sur la technologie ONTAP et son interaction avec les services externes, consultez ces rapports techniques (TR) : ** https://www.netapp.com/pdf.html?item=/media/16334-tr-4172pdf.pdf["Rapport technique de NetApp 4172 : Microsoft Hyper-V sur SMB 3.0 avec les meilleures pratiques de ONTAP"^]
