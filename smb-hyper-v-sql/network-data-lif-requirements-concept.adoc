...
summary: Vous devez tenir compte de certaines exigences relatives aux LIF réseau et données lors de la création de configurations SQL Server ou Hyper-V sur SMB pour des opérations non perturbatrices. 
---
