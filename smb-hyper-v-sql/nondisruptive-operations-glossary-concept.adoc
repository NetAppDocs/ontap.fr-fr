...
summary: Il existe certains concepts relatifs aux opérations non perturbatrices que vous devez comprendre avant de configurer votre solution Hyper-V ou SQL Server sur SMB. 
---
