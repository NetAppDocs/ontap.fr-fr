...
summary: Vous devez connaître certains concepts nécessaires pour comprendre comment Remote VSS est utilisé par les services de sauvegarde avec les configurations Hyper-V sur SMB. 
---
