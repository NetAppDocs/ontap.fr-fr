...
summary: 'Le protocole Witness offre des fonctionnalités de basculement client améliorées pour les partages SMB 3.0 à disponibilité continue. Witness accélère le basculement car il contourne la période de récupération après basculement LIF. Il notifie les serveurs applicatifs lorsqu"un nœud est indisponible sans attendre l"expiration de la connexion SMB 3.0.' 
---
