...
Si vous rencontrez un basculement sur le cluster secondaire dans la relation SM-BC, la destination SnapMirror asynchrone devient défectueuse. Vous devez restaurer manuellement la protection en supprimant et en recréant la relation avec le terminal SnapMirror asynchrone.
