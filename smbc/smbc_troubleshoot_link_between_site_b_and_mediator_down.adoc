...
[role="lead"]
Pour vérifier la connexion du médiateur, utilisez le `snapmirror mediator show` commande. Si l'état de la connexion est inaccessible et que le site B ne parvient pas à atteindre le site B, vous aurez un résultat similaire à celui ci-dessous. Suivez les étapes de la solution pour restaurer la connexion
