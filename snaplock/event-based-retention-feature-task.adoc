...
summary: 'À partir de ONTAP 9.3, vous pouvez définir la durée de conservation d"un fichier après un événement en utilisant la fonction SnapLock _Event Based Retention (EBR)_.' 
---
