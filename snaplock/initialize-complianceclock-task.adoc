...
summary: 'La SnapLock ComplianceClock empêche toute falsification susceptible de modifier la durée de conservation des fichiers WORM. Vous devez initialiser l"horloge de conformité système sur chaque nœud hébergeant un agrégat SnapLock.' 
---
