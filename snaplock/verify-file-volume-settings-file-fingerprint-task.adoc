...
summary: 'Vous pouvez utiliser les commandes volume file fingerprint start et volume file fingerprint dump pour afficher des informations clés sur les fichiers et les volumes, notamment le type de fichier, la date d"expiration du volume, etc.' 
---
