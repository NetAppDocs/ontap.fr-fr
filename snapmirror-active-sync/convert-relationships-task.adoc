...
Vous pouvez convertir une relation de synchronisation active SnapMirror à l'aide d'une protection asynchrone pour utiliser une relation active/active symétrique.
