...
À partir de ONTAP 9.11.1, AIX est pris en charge avec la synchronisation active SnapMirror via une PVR d'ingénierie standard avec l'accord stipulant que les conditions suivantes sont comprises :
