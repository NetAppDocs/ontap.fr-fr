...
À partir d'ONTAP 9.19.1 RC, ARP/AI prend en charge les volumes principaux qui participent aux relations SAN de synchronisation active SnapMirror. Pour plus d'informations, voir link:../anti-ransomware/use-cases-restrictions-concept.html#interoperability-and-vm-considerations["Cas d'utilisation et considérations relatives à la protection autonome contre les ransomwares"].
