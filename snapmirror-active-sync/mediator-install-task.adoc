...
* ONTAP Mediator 1.12.1 ou version ultérieure est installé sur un hôte doté d’un processeur à 2 cœurs.
...
-----END CERTIFICATE-----
----
. Installez les certificats d'autorité de certification racine et intermédiaire sur le cluster principal ou secondaire :
+
...
----
. Répétez l'étape précédente pour installer les certificats d'autorité de certification racine et intermédiaire sur le cluster apparié.
. Consultez les certificats d'autorité de certification auto-signés installés en utilisant le nom généré du certificat :
+
