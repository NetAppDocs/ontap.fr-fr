...
Vous pouvez surveiller l'état et la progression d'une opération de basculement planifiée à l'aide de la commande  `snapmirror failover show`. Par exemple, dans une configuration SAN :
