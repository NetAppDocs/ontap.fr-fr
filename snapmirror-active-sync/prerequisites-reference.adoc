...
* La synchronisation active SnapMirror prend en charge les clusters HA à deux nœuds. À partir de ONTAP 9.16.1, SnapMirror Active Sync prend également en charge des clusters à quatre nœuds.
