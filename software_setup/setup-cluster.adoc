...
Cette procédure s'applique à link:https://docs.netapp.com/us-en/ontap-systems-family/index.html["AFF, ASA FAS"^] et link:https://docs.netapp.com/us-en/ontap-afx/index.html["Systèmes AFX"^]. Si vous possédez un système ASA r2 (ASA A1K, ASA A90, ASA A70, ASA A50, ASA A30, ASA A20 ou ASA C30), suivez les instructions. link:https://docs.netapp.com/us-en/asa-r2/install-setup/initialize-ontap-cluster.html["procédure à suivre"^] utiliser System Manager pour configurer un cluster ONTAP . Les systèmes ASA r2 offrent une expérience ONTAP simplifiée, spécifiquement conçue pour les clients utilisant uniquement un SAN.
