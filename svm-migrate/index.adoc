...
* Les clusters source et destination doivent être dotés de la technologie SnapMirror synchrone link:https://docs.netapp.com/us-en/ontap/system-admin/install-license-task.html["licence installée"].
