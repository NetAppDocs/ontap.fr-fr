...
À partir d'ONTAP 9.19.1, les configurations FC et FC-NVMe à connexion directe sont prises en charge pour certains systèmes AFF, ASA r2 et FAS. Les configurations à connexion directe ne prennent pas en charge la migration SMV.
