...
+
Le `-application` paramètre du `security login` les commandes spécifie la méthode d'accès pour un compte utilisateur. Le `security login` https://docs.netapp.com/us-en/ontap-cli-9141_main/security-login-create.html#description["pages de manuel"^] contiennent des informations supplémentaires.
