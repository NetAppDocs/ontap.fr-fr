...
summary: 'Si un nœud est bloqué au menu de démarrage ou à l"invite de l"environnement de démarrage, vous ne pouvez y accéder que via la console système. Vous pouvez accéder à la console système d"un nœud via une connexion SSH au SP ou au cluster.' 
---
