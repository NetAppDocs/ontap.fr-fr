...
+
** link:https://docs.netapp.com/us-en/ontap-systems/aff-aseries/index.html["Systèmes AFF série A"^]
** link:https://docs.netapp.com/us-en/ontap-systems/aff-cseries/index.html["Systèmes AFF série C"^]
...
[NOTE]
====
Pour plus d'informations sur la configuration d'un cluster à l'aide de l'interface graphique de configuration, consultez la link:../task_admin_add_nodes_to_cluster.html["documentation sur la gestion des nœuds"]. En savoir plus sur `cluster setup` dans la link:https://docs.netapp.com/us-en/ontap-cli/cluster-setup.html["Référence de commande ONTAP"^].
