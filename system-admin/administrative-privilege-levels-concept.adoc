...
summary: 'Les commandes et paramètres ONTAP sont définis selon trois niveaux de privilège : admin, avancé et diagnostic. Les niveaux de privilège reflètent les compétences requises pour effectuer les tâches.' 
---
