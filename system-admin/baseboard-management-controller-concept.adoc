...
summary: 'Sur certaines plateformes matérielles, le logiciel est personnalisé pour prendre en charge un nouveau contrôleur intégré appelé Baseboard Management Controller. Le BMC dispose de commandes en ligne de commandes que vous pouvez utiliser pour gérer l"appareil à distance.' 
---
