...
summary: 'Les administrateurs du cluster gèrent l"ensemble du cluster et les machines virtuelles de stockage qu"il contient. Les administrateurs de SVM gèrent uniquement leurs propres SVM de données.' 
---
