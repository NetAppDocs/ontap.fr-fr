...
summary: 'L"interface de ligne de commandes ONTAP offre une vue de l"interface de gestion basée sur les commandes. Vous saisissez les commandes à l"invite du système de stockage et les résultats s"affichent sous forme de texte.' 
---
