...
* link:https://docs.netapp.com/us-en/ontap-cli/storage-port-show.html["spectacle du port de stockage"^]
* link:https://docs.netapp.com/us-en/ontap-cli/storage-shelf-show.html["exposition d'étagères de rangement"^]
* link:https://docs.netapp.com/us-en/ontap-cli/system-health-alert-delete.html["suppression de l'alerte de santé du système"^]
