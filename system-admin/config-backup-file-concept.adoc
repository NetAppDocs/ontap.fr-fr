...
summary: 'Les fichiers de sauvegarde de configuration sont des fichiers d"archive contenant les informations relatives à toutes les options configurables nécessaires au bon fonctionnement du cluster et des nœuds qui le composent.' 
---
