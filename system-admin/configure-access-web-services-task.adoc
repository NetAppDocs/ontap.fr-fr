...
summary: 'La configuration de l"accès aux services Web permet aux utilisateurs autorisés d"utiliser HTTP ou HTTPS pour accéder au contenu du service sur le cluster ou une machine virtuelle de stockage.' 
---
