...
summary: 'Vous pouvez créer un message du jour pour communiquer des informations aux utilisateurs authentifiés de l"interface de ligne de commande. Le MOTD s"affiche dans une session console ou une session SSH après l"authentification de l"utilisateur, mais avant l"apparition de l"invite clustershell.' 
---
