...
.Étapes
Vous pouvez télécharger les fichiers de licence ONTAP One pour les systèmes disposant déjà de bundles de fichiers de licence NetApp et pour les systèmes dont les clés de licence à 28 caractères ont été converties en fichiers de licence NetApp sur les systèmes exécutant ONTAP 9.10.1 et versions ultérieures. Moyennant des frais, vous pouvez également mettre à niveau les systèmes d’ONTAP Base vers ONTAP One. Pour plus d’informations sur le téléchargement des fichiers de licence NetApp, consultez l’article de la base de connaissances link:https://kb.netapp.com/nss/Licensing/How_to_download_NLF_licenses_from_the_NetApp_Support_Site["Comment télécharger les licences NLF depuis le site d'assistance NetApp"^].
