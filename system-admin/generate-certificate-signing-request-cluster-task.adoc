...
summary: 'Vous pouvez utiliser la commande `security certificate generate-csr` pour générer une demande de signature de certificat. Après traitement de votre demande, l"autorité de certification vous envoie le certificat numérique signé.' 
---
