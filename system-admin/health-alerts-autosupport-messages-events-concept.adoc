...
summary: 'Les alertes relatives à l"état du système déclenchent des messages AutoSupport et des événements dans le système de gestion des événements, vous permettant de surveiller l"état du système à l"aide de messages AutoSupport et du système de gestion des événements, en plus d"utiliser directement le système de contrôle de l"état.' 
---
