...
summary: 'Le sous-type de certificat du protocole d"interopérabilité de gestion des clés (KMIP), ainsi que les types client et serveur-ca, spécifient que le certificat est utilisé pour l"authentification mutuelle du cluster et d"un gestionnaire de clés externe, tel qu"un serveur KMIP.' 
---
