...
summary: 'ONTAP vous permet de configurer une bannière de connexion ou un message du jour pour communiquer des informations administratives à System Manager et aux utilisateurs de la ligne de commandes (CLI) du cluster ou de la machine virtuelle de stockage.' 
---
