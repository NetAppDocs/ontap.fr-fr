...
Pour obtenir la liste des séquences d'échappement pouvant être utilisées pour générer dynamiquement du contenu pour le MOTD, reportez-vous au link:https://docs.netapp.com/us-en/ontap-cli-9141//security-login-motd-modify.html#parameters["référence de commande"].
