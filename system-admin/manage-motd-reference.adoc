...
summary: 'Vous pouvez gérer le message du jour au niveau du cluster ou de la SVM. Par défaut, le message du jour configuré pour le cluster est également activé pour toutes les SVM. De plus, un message du jour au niveau de la SVM peut être configuré pour chaque SVM. Le message du jour au niveau du cluster peut être activé ou désactivé pour chaque SVM par l"administrateur du cluster.' 
---
