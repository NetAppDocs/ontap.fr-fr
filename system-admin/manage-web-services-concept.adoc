...
summary: 'Vous pouvez activer ou désactiver un service Web pour le cluster ou une machine virtuelle de stockage, afficher les paramètres des services Web et contrôler si les utilisateurs d"un rôle peuvent accéder à un service Web.' 
---
