...
image:scrn_en_drw_fc-302020-direct-sing-on.png["diagramme des contrôleurs directement connectés avec un ou plusieurs hôtes directement connectés au nœud"]
...
image:r-oc-set-iscsi-singlenetwork-singlenode.png["Configuration à un seul nœud en réseau à connexion directe"]
...
image:scrn_en_drw_fc-62xx-multi-singlecontroller.png["diagramme d'une configuration multistructure à un seul nœud"]
