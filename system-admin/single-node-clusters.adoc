...
summary: 'Un cluster à nœud unique est une implémentation particulière d"un cluster fonctionnant sur un nœud autonome. Les clusters à nœud unique sont déconseillés car ils n"offrent aucune redondance. Si le nœud tombe en panne, l"accès aux données est perdu.' 
---
...
https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["Rapport technique NetApp 4684 : implémentation et configuration de SAN modernes avec NVMe-of"^]
