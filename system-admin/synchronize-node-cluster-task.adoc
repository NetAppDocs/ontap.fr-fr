...
summary: 'Si le quorum est atteint à l"échelle du cluster, mais qu"un ou plusieurs nœuds sont désynchronisés avec le cluster, vous devez synchroniser le nœud pour restaurer la base de données répliquée sur le nœud et le remettre en quorum.' 
---
