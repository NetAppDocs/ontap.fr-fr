...
summary: 'L"aliasage simplifie le processus d"identification des périphériques. L"aliasage associe un nom de chemin physique ou un numéro de série d"une bande ou d"un changeur de supports à un nom d"alias persistant, mais modifiable.' 
---
