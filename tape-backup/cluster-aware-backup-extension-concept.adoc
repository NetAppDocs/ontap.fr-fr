...
summary: 'CAB est une extension du protocole NDMP v4. Cette extension permet au serveur NDMP d"établir une connexion de données sur un nœud propriétaire d"un volume. Elle permet également à l"application de sauvegarde de déterminer si les volumes et les lecteurs de bande se trouvent sur le même nœud au sein d"un cluster.' 
---
