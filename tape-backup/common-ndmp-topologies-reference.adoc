...
summary: 'NDMP prend en charge un certain nombre de topologies et de configurations entre les applications de sauvegarde et les systèmes de stockage ou d"autres serveurs NDMP fournissant des services de données et de bandes.' 
---
