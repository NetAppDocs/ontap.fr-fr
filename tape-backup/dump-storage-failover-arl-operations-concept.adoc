...
summary: 'Avant d"effectuer des opérations de sauvegarde ou de restauration dump, il est important de comprendre leur fonctionnement lors d"un basculement de stockage ou d"une relocalisation d"agrégats. L"option -override-vetoes détermine le comportement du moteur dump pendant un basculement de stockage ou une opération ARL.' 
---
= Fonctionnement du vidage avec le basculement de stockage ONTAP et les opérations ARL
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
