...
summary: Vous pouvez utiliser la fonctionnalité de récupération par accès direct amélioré pour le DAR de répertoires et le DAR de fichiers et de flux NT. Par défaut, la fonctionnalité DAR améliorée est activée. 
---
