...
À partir de ONTAP 9.13.1, la sauvegarde sur bande à l'aide de SMTape est prise en charge par xref:../snapmirror-active-sync/interoperability-reference.html[Synchronisation active SnapMirror].
