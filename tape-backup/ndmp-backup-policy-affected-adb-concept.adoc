...
summary: 'Lorsque l"équilibreur de données automatique est activé, celui-ci analyse les statistiques d"utilisation des agrégats pour identifier l"agrégat qui a dépassé le pourcentage d"utilisation à seuil élevé configuré.' 
---
