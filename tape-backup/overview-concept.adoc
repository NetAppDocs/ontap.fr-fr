...
summary: 'ONTAP prend en charge la sauvegarde et la restauration sur bande via le protocole Network Data Management Protocol. NDMP permet de sauvegarder les données des systèmes de stockage directement sur bande, optimisant ainsi l"utilisation de la bande passante réseau. ONTAP prend en charge les moteurs de sauvegarde sur bande dump et SMTape.' 
---
