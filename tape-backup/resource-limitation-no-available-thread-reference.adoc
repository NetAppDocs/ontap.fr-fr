...
summary: 'Le nombre maximal de flux d"entrée/sortie de bande locaux actifs est actuellement utilisé. Vous pouvez avoir un maximum de 16 lecteurs de bande locaux actifs.' 
---
