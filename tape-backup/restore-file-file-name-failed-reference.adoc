...
summary: 'Lorsqu"une opération DAR d"un fichier dont le nom est identique à celui d"un LUN sur le volume de destination est effectuée, l"opération DAR échoue.' 
---
