...
summary: 'ONTAP prend en charge un maximum de 64 connexions simultanées de lecteurs de bande, 16 changeurs de supports et 16 périphériques de pont ou de routeur pour chaque système de stockage, dans n"importe quelle combinaison de connexions Fibre Channel, SCSI ou SAS.' 
---
