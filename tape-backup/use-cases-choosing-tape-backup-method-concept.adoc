...
summary: 'ONTAP prend en charge deux moteurs de sauvegarde : SMTape et dump. Vous devez connaître les cas d’utilisation des moteurs de sauvegarde SMTape et dump afin de vous aider à choisir le moteur de sauvegarde pour effectuer les opérations de sauvegarde et de restauration sur bande.' 
---
