...
NOTE: Les mesures de la capacité utilisée s'affichent différemment en fonction de la version de System Manager que vous utilisez, comme expliqué dans la link:./concepts/concept_capacity_measurements_in_sm.html["Mesures de la capacité dans System Manager"].
