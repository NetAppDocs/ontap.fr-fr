...
Cette procédure s'applique aux systèmes FAS, AFF et ASA actuels. Si vous disposez d'un système ASA r2 (ASA A1K, ASA A70 ou ASA A90), reportez-vous à link:https://docs.netapp.com/us-en/asa-r2/monitor/monitor-performance.html["procédure à suivre"^] la pour contrôler les performances de votre cluster. Les systèmes ASA r2 simplifient l'expérience ONTAP propre aux clients SAN.
