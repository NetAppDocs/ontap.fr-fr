...
.Étapes
. Ajout d'un nouveau volume dans une machine virtuelle de stockage compatible NFS
+
...
NOTE: Une fois le volume enregistré, revenez à  Pour terminer le provisionnement des serveurs Linux à l'aide de NFS.
