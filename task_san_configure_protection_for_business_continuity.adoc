...
.Avant de commencer
* Vous devez avoir un link:https://docs.netapp.com/us-en/ontap/system-admin/manage-license-task.html#view-details-about-a-license["Licence SnapMirror synchrone"].
