...
summary: Vous pouvez appliquer une mise à jour du firmware aux périphériques compatibles de votre cluster, tels que les disques, les baies de disques, le service processor ou le Baseboard Management Controller. 
---
...
[role="lead"]
À partir d'ONTAP 9.9.1, si vous êtes enregistré auprès de link:https://docs.netapp.com/us-en/active-iq/["Conseiller digital"^], vous pouvez recevoir des alertes dans System Manager vous informant lorsque des mises à jour du firmware pour les périphériques pris en charge, tels que les disques, les baies de disques, le service processor (SP) ou le Baseboard Management Controller (BMC), sont en attente sur le cluster.

Si vous utilisez ONTAP 9.8 ou si vous n'êtes pas inscrit auprès de Digital Advisor, rendez-vous sur le NetApp Support Site pour télécharger les mises à jour du firmware.
...
.Étapes
Suivez la procédure appropriée en fonction de votre version d'ONTAP et si vous êtes inscrit auprès de Digital Advisor.
