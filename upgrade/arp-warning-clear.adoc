...
summary: 'Avant de mettre à niveau ONTAP, répondez à toute alerte d"activité anormale dans ARP.' 
---
= Résolvez les avertissements d'activité ARP avant une mise à niveau ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
