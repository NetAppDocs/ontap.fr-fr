...
NOTE: Si vous effectuez une mise à niveau vers ONTAP 9.15.1 ou une version ultérieure via NetApp, suivez les instructionslink:https://docs.netapp.com/us-en/console-software-updates/get-started/software-updates.html["procédure de mise à niveau dans la documentation de la console NetApp"^] .
...
+
<<<<<<< HEAD Pour le FTP anonyme, vous devez spécifier l'URL au format +ftp://anonymous@ftpserver+.



[]
=====
Pour le FTP anonyme, vous devez spécifier l'URL au format \ftp://anonymous@ftpserver. >>>>>>> 20a8478e44f7b38038f6e148d4bfb0026800d5ff
