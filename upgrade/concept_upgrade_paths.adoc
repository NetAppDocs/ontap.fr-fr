...
*Configurations MetroCluster à l'attention* :
Si vous mettez à niveau une configuration IP MetroCluster de 9.8 à 9.10.1 sur l'une des plates-formes suivantes, vous devez effectuer une mise à niveau vers 9.9.1 avant de passer à 9.10.1.
...
- 9.2 -> 9.3
- 9.3 -> 9.7 (multi-saut direct, nécessite des images pour 9.5 et 9.7)
- 9.7 -> 9.9.1 (multi-saut direct, nécessite des images pour 9.8 et 9.9.1)
- 9.9.1 -> 9.13.1 
...
- 9.1 -> 9.3
- 9.3 -> 9.7 (multi-saut direct, nécessite des images pour 9.5 et 9.7)
- 9.7 -> 9.12.1 (multi-saut direct, nécessite des images pour 9.8 et 9.12.1) 
