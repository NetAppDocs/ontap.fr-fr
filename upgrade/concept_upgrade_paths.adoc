...
+
Par exemple, vous pouvez utiliser la voie de mise à niveau directe de la version 9.12.1 à la version 9.13.1, ou de la version 9.13.1 à la version 9.17.1.
...
+
Par exemple, si vous utilisez actuellement la version 9.8 et que vous souhaitez passer à la version 9.16.1, vous devez effectuer une mise à niveau en plusieurs étapes : d’abord de la version 9.8 à la version 9.12.1, puis de la version 9.12.1 à la version 9.16.1.  Les mises à niveau depuis les versions précédentes peuvent nécessiter trois étapes ou plus, avec plusieurs mises à niveau intermédiaires.
...
=== À partir d'ONTAP 9.8 et versions ultérieures

Les mises à niveau automatisées et manuelles à partir d'ONTAP 9.8 et versions ultérieures suivent les mêmes chemins de mise à niveau.

.À partir de ONTAP 9.15.1 et versions ultérieures
[%collapsible]
====
Les chemins de mise à niveau suivants sont pris en charge à partir d'ONTAP 9.15.1 et versions ultérieures pour les mises à niveau automatisées et manuelles.
...
| 9.18.1 | 9.19.1 | directe 


.2+| 9.17.1 | 9.19.1 | directe 


| 9.18.1 | directe 


.3+| 9.16.1 | 9.19.1 | directe 
...
|===
====
.À partir d'ONTAP 9.14.1
[%collapsible]
====
Les chemins de mise à niveau suivants sont pris en charge à partir de ONTAP 9.14.1 pour les mises à niveau automatisées et manuelles.

[cols="25,25,50"]
|===
| Si votre version actuelle d'ONTAP est... | Et votre version ONTAP cible est… | Votre chemin de mise à niveau automatique ou manuel est… 
...
|===
====
.À partir d'ONTAP 9.13.1
[%collapsible]
====
Les chemins de mise à niveau suivants sont pris en charge à partir d'ONTAP 9.13.1 pour les mises à niveau automatisées et manuelles.
...
|===
====
.À partir d'ONTAP 9.12.1
[%collapsible]
====
Les chemins de mise à niveau suivants sont pris en charge à partir d'ONTAP 9.12.1 pour les mises à niveau automatisées et manuelles.
...
[%collapsible]
====
Les chemins de mise à niveau suivants sont pris en charge à partir d'ONTAP 9.11.1 pour les mises à niveau automatisées et manuelles.
...
[%collapsible]
====
Les chemins de mise à niveau suivants sont pris en charge à partir d'ONTAP 9.10.1 pour les mises à niveau automatisées et manuelles.
...
[%collapsible]
====
Les chemins de mise à niveau suivants sont pris en charge à partir d'ONTAP 9.9.1 pour les mises à niveau automatisées et manuelles.
...
[%collapsible]
====
Les chemins de mise à niveau suivants sont pris en charge à partir d'ONTAP 9.8 pour les mises à niveau automatisées et manuelles.
...
=== À partir d'ONTAP 9.7 et 9.6

Pour ONTAP 9.7 et 9.6, les chemins de mise à niveau automatisés et manuels peuvent varier en fonction de la version ONTAP cible.

.Depuis ONTAP 9.7
[%collapsible]
====
La procédure de mise à niveau manuelle d'ONTAP 9.7 vers les versions 9.10.1 et 9.11.1 diffère de la procédure de mise à niveau automatique. Ces différences sont indiquées dans le tableau ci-dessous. Pour les mises à niveau d'ONTAP 9.7 vers toutes les autres versions d'ONTAP, les procédures de mise à niveau automatique et manuelle suivent la même procédure.
...
| 9.11.1  a| 
* Chemin de mise à niveau automatisé
+
multi-sauts directs (nécessite des images pour 9.8 et 9.11.1)

* Chemin de mise à niveau manuel
+
multi-étages
...
[%collapsible]
====
La procédure de mise à niveau manuelle d'ONTAP 9.6 vers 9.10.1 diffère de la procédure de mise à niveau automatique. Cette différence est indiquée dans le tableau ci-dessous. Pour les mises à niveau d'ONTAP 9.6 vers toutes les autres versions d'ONTAP, les procédures de mise à niveau automatique et manuelle suivent la même procédure.
...
Les procédures de mise à niveau depuis ONTAP 9.5 varient selon que vous effectuiez une mise à niveau automatisée ou manuelle.

.Chemins de mise à niveau automatisés
[%collapsible]
====
Utilisez les chemins de mise à niveau suivants pour les mises à niveau automatisées à partir de ONTAP 9.5.

[cols="25,25,50"]
|===
| Si votre version actuelle d'ONTAP est... | Et votre version ONTAP cible est… | Votre chemin de mise à niveau automatique est… 
...
[%collapsible]
====
Utilisez les chemins de mise à niveau suivants pour les mises à niveau manuelles depuis ONTAP 9.5

[cols="25,25,50"]
|===
| Si votre version actuelle d'ONTAP est... | Et votre version ONTAP cible est… | Votre chemin de mise à niveau manuelle est… 
...
Les chemins de mise à niveau à partir d'ONTAP 9.4, 9.3, 9.2, 9.1 et 9.0 varient selon que vous effectuiez une mise à niveau automatisée ou une mise à niveau manuelle.

.Chemins de mise à niveau automatisés
[%collapsible]
====
Utilisez les chemins de mise à niveau suivants pour les mises à niveau automatisées à partir d'ONTAP 9.4, 9.3, 9.2, 9.1 et 9.0.
...
[%collapsible]
====
Utilisez les chemins de mise à niveau suivants pour les mises à niveau manuelles à partir d'ONTAP 9.4, 9.3, 9.2, 9.1 et 9.0.
