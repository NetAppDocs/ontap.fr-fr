...
* Si vous effectuez une mise à niveau automatisée sans interruption à l'aide d'un link:concept_upgrade_paths.html#types-of-upgrade-paths["chemin de mise à niveau multi-sauts direct"], Vous devez télécharger le progiciel pour la version intermédiaire de ONTAP et la version cible de ONTAP requise pour votre mise à niveau.  Par exemple, si vous effectuez une mise à niveau de ONTAP 9.8 vers ONTAP 9.13.1, vous devez télécharger les progiciels pour ONTAP 9.12.1 et ONTAP 9.13.1.  Voir link:concept_upgrade_paths.html#supported-upgrade-paths["chemins de mise à niveau pris en charge"] pour déterminer si votre chemin de mise à niveau nécessite le téléchargement d'un progiciel intermédiaire.
