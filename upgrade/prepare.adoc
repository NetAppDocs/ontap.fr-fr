...
. Veuillez consulter les sections _Précautions relatives à la mise à niveau_ et _Problèmes et limitations connus_ dans la link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2492508["Notes de mise à jour de ONTAP 9"^] pour votre version cible.
+
