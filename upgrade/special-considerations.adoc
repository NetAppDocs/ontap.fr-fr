...
| Mon cluster dispose-t-il de relations SnapMirror ?  a| 
...
* link:../data-protection/compatible-ontap-versions-snapmirror-concept.html["Vérifier la compatibilité des versions ONTAP pour les relations SnapMirror"]
...
| Est-ce que je mets à niveau à partir de ONTAP 9.3 ? | xref:task_preparing_all_load_sharing_mirrors_for_a_major_upgrade.html[Préparez tous les miroirs de partage de charge] 
|===