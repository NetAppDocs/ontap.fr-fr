...
---
= NDU ONTAP manuel sur une configuration MetroCluster à quatre ou huit nœuds
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Une mise à niveau manuelle non disruptive (NDU) d'une configuration MetroCluster à quatre ou huit nœuds implique la préparation de la mise à jour, la mise à jour simultanée des paires DR dans chacun des un ou deux groupes DR et l'exécution des tâches post-mise à niveau.

.Description de la tâche
* Vous devez utiliser l'interface de ligne de commandes (CLI) ONTAP pour effectuer cette tâche.
...
----
+
L'exemple suivant montre que l'image système2 (image ONTAP cible) est la version par défaut et actuelle sur le nœud_A_1 :
...
----
+
L'exemple suivant montre que l'image système2 (image ONTAP cible) est la version par défaut et actuelle sur le nœud_B_1 :
...
----
+
L'exemple suivant montre que l'image système2 (image ONTAP cible) est la version par défaut et actuelle sur le nœud_A_2 :
...
----
+
L'exemple suivant montre que l'image système2 (image ONTAP cible) est la version par défaut et actuelle sur le nœud_B_2 :
