...
---
= Mettez à niveau manuellement un cluster ONTAP standard de manière disruptive
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Vous devez utiliser l'interface de ligne de commandes ONTAP (CLI) pour effectuer une mise à niveau manuelle disruptive.
