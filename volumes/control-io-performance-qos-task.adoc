...
summary: 'Vous pouvez contrôler les performances d"entrée et de sortie des volumes FlexVol à l"aide de groupes de stratégies QoS de stockage pour gérer les charges de travail.' 
---
= Contrôlez et surveillez les performances d'E/S des volumes FlexVol ONTAP avec Storage QoS
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
