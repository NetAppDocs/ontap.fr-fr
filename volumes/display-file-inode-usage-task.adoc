...
summary: 'Déterminez si vous devez augmenter le nombre d"inodes de vos volumes FlexVol pour éviter qu"ils n"atteignent leur limite de fichiers.' 
---
= Déterminer l'utilisation des fichiers et des inodes pour un volume ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
