...
---
= Activer la prise en charge des volumes et des fichiers volumineux dans ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Et la suite ?
Si vous avez activé la prise en charge des volumes et des fichiers volumineux pour un client NFS, le client doit être remonté avant que la nouvelle taille maximale des fichiers ne prenne effet.
