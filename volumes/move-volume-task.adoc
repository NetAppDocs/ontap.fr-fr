...
summary: 'Déplacez un FlexVol volume vers un autre agrégat, nœud ou les deux au sein de la même machine virtuelle de stockage afin d"équilibrer la capacité de stockage.' 
---
