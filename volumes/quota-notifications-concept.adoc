...
summary: Les notifications de quota sont des messages envoyés au système de gestion des événements et également configurés comme des traps SNMP. 
---
= Notifications de quota ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
