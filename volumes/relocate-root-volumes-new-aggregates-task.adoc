...
---
= Déplacer un volume racine ONTAP vers de nouveaux agrégats
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Un redémarrage du nœud a lieu lors du déplacement du volume racine, ce qui met fin à toutes les sessions SSH actives.
