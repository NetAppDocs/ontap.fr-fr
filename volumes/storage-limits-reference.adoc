...
+
Pour obtenir des informations spécifiques à la plate-forme et pour obtenir les dernières informations sur la prise en charge, reportez-vous à la section https://["Hardware Universe"^].
...
https://["Recherchez les notes de version de votre version de Cloud Volumes ONTAP"]
