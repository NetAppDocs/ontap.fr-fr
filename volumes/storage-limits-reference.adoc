...
+
image:hardware-universe-products.png["Menu des produits Hardware Universe"]

. Sélectionnez votre plate-forme.
+
image:hardware-universe-platforms.png["Menu plates-formes Hardware Universe"]

. Sélectionnez la version appropriée de ONTAP, puis **Afficher les résultats**.
+
image:hardware-universe-os-filter.png["Menu de filtre Hardware Universe OS"]
